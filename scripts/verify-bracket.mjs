...
// kept byte-identical to the solver in app/bracket/BracketClient.jsx
...
console.log(`verify-bracket: all ${PUZZLES.length} boards pass (unique table, minimal clue set, structure OK)`);
