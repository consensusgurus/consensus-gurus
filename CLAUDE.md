...
| Defend | a hold for three instead of a hold for two, so a third only-move to find and a longer attack to read before committing to the first (from 2026-08-11) |
