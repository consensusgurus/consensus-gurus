      ...
      <section style={{ padding: '10px 16px 80px', maxWidth: 1200, margin: '0 auto' }}>
        ...
        <div className="cg-controls">
          ...
          <div className="cg-c-sort" style={{ position: 'relative', minWidth: 0, order: HOME_V2 ? 2 : 1 }} onClick={(e) => e.stopPropagation()}>
            <button className="cg-ctrl-btn cg-sort-btn" onClick={() => { setSortOpen((o) => !o); setCatOpen(false); }} aria-haspopup="true" aria-expanded={sortOpen} style={{ position: 'relative', width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, background: COLORS.ink, color: COLORS.cream, border: `2px solid ${COLORS.ember}`, boxShadow: '0 0 0 3px rgba(192,57,43,0.30)', padding: '0 34px', fontFamily: 'DM Mono, monospace', fontSize: 11, letterSpacing: '0.14em', textTransform: 'uppercase', fontWeight: 600, cursor: 'pointer', whiteSpace: 'nowrap', overflow: 'hidden' }}>
