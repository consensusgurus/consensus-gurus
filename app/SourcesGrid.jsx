...
export default function SourcesGrid({ sources = [], minColWidth = 190, linked = false, theme = 'paper' }) {
  const PAL = theme === 'site'
    ? { chipBg: '#ffffff', chipBorder: 'rgba(20,22,28,0.10)', hoverBg: '#f3f5f8', hoverShadow: '#0e1d40', logoBg: '#f7f8fa', logoBorder: 'rgba(20,22,28,0.08)', logoFont: "'Manrope',system-ui,sans-serif", logoColor: '#9aa0ab', nameFont: "'Manrope',system-ui,sans-serif", nameColor: '#1c1e24', countColor: '#9aa0ab' }
