...
// Bracket launched 2026-07-24 as one of the daily games: linked from the daily
// strip, the /daily archive, and the sitemap (/bracket is the canonical,
// evergreen URL). One board a day, machine-verified (scripts/verify-bracket.mjs).
//
...
export const metadata = {
  title: 'Bracket — Free Daily Logic Game: Rebuild the Results | Source of Truths',
  ...
  openGraph: { title: 'Bracket — Rebuild the Lost Results Table', description: 'Everyone played everyone once. Win 3, draw 1. The sheet is gone and a few facts survive, and only one set of results fits them all.', url: '/bracket', type: 'website', siteName: 'Source of Truths' },
  twitter: { card: 'summary_large_image', title: 'Bracket — Rebuild the Lost Results Table', description: 'Everyone played everyone once. Win 3, draw 1. The sheet is gone and a few facts survive, and only one set of results fits them all.' },
};
