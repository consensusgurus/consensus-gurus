// Puzzle data for Bracket, the daily round-robin reconstruction. Imported ONLY
// by the server page (app/bracket/page.js), which filters live<=today before
...
// (scripts/verify-bracket.mjs) to admit exactly one table, and to carry a
