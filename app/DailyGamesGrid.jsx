...
const GAMES = [
  ...
  { key: 'tables', href: '/tables', name: 'Tables', tag: 'Rebuild the results', img: '/games/btn-tables.png' },
...
const CATEGORIES = [
  ...
  { key: 'logic', label: 'Logic', keys: ['alibi', 'jester', 'sworn', 'axiom', 'hearsay', 'venn', 'tables'] },
];
