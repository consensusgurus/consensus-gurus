    ...
    >
      {!loaded ? (
        ...
        >
          ...
          <div style={{ width: 42, height: 42, borderRadius: 12, background: 'linear-gradient(135deg,#2f6fe4,#233a63)', display: 'flex', alignItems: 'center', justifyContent: 'center', animation: 'sotpulse 1.2s ease-in-out infinite' }}>
