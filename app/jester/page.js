...
export const metadata = {
  title: 'Jester — Daily Logic Puzzle: Seat the Court | Source of Truths',
  description:
  ...
  appleWebApp: { capable: true, statusBarStyle: 'black-translucent', title: 'Jester' },
  openGraph: {
    title: 'Jester — Seat the Court, Every Day',
    description:
...
const gameJsonLd = {
  ...
  '@type': 'Game',
  name: 'Jester',
  alternateName: 'Jester — Daily Court-Placement Logic Puzzle',
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Jester' },
  ],
};
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f7f8fa', fontFamily: "'Manrope', system-ui, sans-serif", display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
      <div style={{ textAlign: 'center', maxWidth: 420 }}>
        ...
        <h1 style={{ fontSize: 24, fontWeight: 800, color: '#1c1e24', margin: '0 0 8px' }}>Jester opens {first ? first.dateLabel : 'soon'}.</h1>
