...
import {
  ...
  Flame, Frame, Contrast, Layers, FileText, Waypoints,
} from 'lucide-react';
...
const LAUNCH_PIN = { keys: ['paths', 'redact', 'strata', 'suffice', 'turn', 'chain', 'hands', 'glyph', 'babel', 'feud'], until: '2026-09-15' };
function etTodayEC() {
...
export const DAILY_GAMES = [
  ...
  { key: 'paths', cat: 'logic',      name: 'Paths',  tag: 'Link every town, cheaply',  blurb: 'One depot, eight towns, a river and two ridges. Link them all for as little as you can, against a proven cheapest network.', href: '/paths' },
