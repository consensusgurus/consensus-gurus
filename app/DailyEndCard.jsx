...
const ALL_DAILY_GAMES = [
  ...
  { key: 'pricer',  cat: 'numbers',  name: 'Pricer',  tag: 'Higher price wins',        blurb: 'Sixteen real things from one category, seeded by price. Call every matchup before a single price tag is revealed.', href: '/pricer' },
