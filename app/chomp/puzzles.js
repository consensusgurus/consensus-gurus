...
export const PUZZLES = [
  ...
  { num: 25, quizId: 'chomp-9-1-26', live: '2026-09-01', dateLabel: 'September 1, 2026', sunday: false, w: 7, h: 7, start: [1,2], floor: 19, min: 33, walls: [[1,5], [5,0], [2,4], [2,1], [5,5], [3,1], [2,2]],
    cast: ['bulldog', 'bull', 'wildcat', 'smokey', 'ibis', 'tiger', 'seminole', 'longhorn'],
    pellets: [[2,3], [4,3], [5,2], [5,4], [3,4], [2,5], [3,6], [0,4]] },
  { num: 26, quizId: 'chomp-9-2-26', live: '2026-09-02', dateLabel: 'September 2, 2026', sunday: false, w: 7, h: 7, start: [2,5], floor: 19, min: 37, walls: [[2,1], [5,4], [0,5], [4,4], [6,4]],
    cast: ['bulldog', 'knight', 'wildcat', 'tiger', 'seminole', 'longhorn', 'ibis', 'bull', 'gamecock'],
    pellets: [[3,4], [2,3], [1,2], [3,2], [4,3], [4,1], [5,2], [6,3], [6,6]] },
  { num: 27, quizId: 'chomp-9-3-26', live: '2026-09-03', dateLabel: 'September 3, 2026', sunday: false, w: 7, h: 7, start: [2,4], floor: 23, min: 35, walls: [[5,4], [1,4], [1,2], [4,5], [1,3], [2,0], [2,2]],
    cast: ['bulldog', 'tiger', 'bull', 'wildcat', 'knight', 'gamecock', 'seminole', 'ibis', 'eagle'],
    pellets: [[3,5], [4,4], [3,3], [4,2], [4,0], [2,1], [1,0], [0,1], [5,0]] },
  { num: 28, quizId: 'chomp-9-4-26', live: '2026-09-04', dateLabel: 'September 4, 2026', sunday: false, w: 7, h: 7, start: [5,3], floor: 23, min: 37, walls: [[1,5], [1,1], [2,2], [4,3], [0,3], [2,1]],
    cast: ['bulldog', 'knight', 'longhorn', 'ibis', 'gamecock', 'seminole', 'eagle', 'tiger', 'bull'],
    pellets: [[4,4], [3,5], [2,4], [3,3], [3,1], [4,2], [6,3], [6,5], [5,0]] },
  { num: 29, quizId: 'chomp-9-5-26', live: '2026-09-05', dateLabel: 'September 5, 2026', sunday: false, w: 7, h: 7, start: [4,1], floor: 27, min: 39, walls: [[1,3], [4,3], [4,4], [0,1], [0,5]],
    cast: ['bulldog', 'smokey', 'ibis', 'longhorn', 'tiger', 'bull', 'seminole', 'eagle', 'knight', 'wildcat'],
    pellets: [[5,2], [3,2], [2,1], [2,3], [3,4], [4,5], [5,4], [6,2], [4,0], [6,4]] },
  { num: 30, quizId: 'chomp-9-6-26', live: '2026-09-06', dateLabel: 'September 6, 2026', sunday: true, w: 7, h: 7, start: [5,5], floor: 27, min: 41, walls: [[4,4], [1,1], [3,6], [4,2], [1,5]],
    cast: ['bulldog', 'seminole', 'wildcat', 'knight', 'eagle', 'smokey', 'tiger', 'gamecock', 'bull', 'longhorn', 'ibis'],
    pellets: [[5,3], [3,3], [2,4], [1,3], [2,2], [3,1], [5,2], [6,1], [5,0], [3,0], [6,3]] },
  { num: 31, quizId: 'chomp-9-7-26', live: '2026-09-07', dateLabel: 'September 7, 2026', sunday: false, w: 7, h: 7, start: [1,5], floor: 20, min: 32, walls: [[4,3], [5,6], [6,4], [5,1], [5,2], [0,3]],
    cast: ['bulldog', 'smokey', 'eagle', 'gamecock', 'knight', 'ibis', 'tiger', 'longhorn'],
    pellets: [[2,4], [3,3], [2,2], [3,1], [1,1], [1,3], [3,5], [4,2]] },
  { num: 32, quizId: 'chomp-9-8-26', live: '2026-09-08', dateLabel: 'September 8, 2026', sunday: false, w: 7, h: 7, start: [2,2], floor: 18, min: 34, walls: [[1,1], [3,1], [3,2], [3,3], [0,6], [1,2]],
    cast: ['bulldog', 'longhorn', 'gamecock', 'wildcat', 'tiger', 'eagle', 'knight', 'smokey'],
    pellets: [[1,3], [2,4], [3,5], [4,4], [5,5], [6,6], [6,4], [4,6]] },
  { num: 33, quizId: 'chomp-9-9-26', live: '2026-09-09', dateLabel: 'September 9, 2026', sunday: false, w: 7, h: 7, start: [4,1], floor: 21, min: 35, walls: [[1,1], [2,3], [3,3], [1,2], [3,4], [1,4]],
    cast: ['bulldog', 'longhorn', 'seminole', 'eagle', 'ibis', 'tiger', 'bull', 'smokey', 'wildcat'],
    pellets: [[2,1], [4,2], [5,3], [4,4], [4,6], [3,5], [2,6], [1,5], [5,5]] },
  { num: 34, quizId: 'chomp-9-10-26', live: '2026-09-10', dateLabel: 'September 10, 2026', sunday: false, w: 7, h: 7, start: [5,2], floor: 19, min: 37, walls: [[5,1], [4,1], [3,4], [3,1], [0,0], [6,4]],
    cast: ['bulldog', 'smokey', 'eagle', 'gamecock', 'wildcat', 'bull', 'ibis', 'longhorn', 'tiger'],
    pellets: [[4,3], [2,3], [1,4], [2,5], [4,5], [5,4], [6,5], [5,6], [5,3]] },
  { num: 35, quizId: 'chomp-9-11-26', live: '2026-09-11', dateLabel: 'September 11, 2026', sunday: false, w: 7, h: 7, start: [4,5], floor: 24, min: 36, walls: [[2,5], [3,4], [2,1], [3,3], [1,5], [0,3], [4,0]],
    cast: ['bulldog', 'smokey', 'tiger', 'eagle', 'bull', 'gamecock', 'seminole', 'ibis', 'longhorn'],
    pellets: [[5,4], [4,3], [5,2], [3,1], [1,0], [0,1], [1,2], [2,3], [5,0]] },
  { num: 36, quizId: 'chomp-9-12-26', live: '2026-09-12', dateLabel: 'September 12, 2026', sunday: false, w: 7, h: 7, start: [4,5], floor: 23, min: 37, walls: [[3,3], [1,3], [1,4], [0,1], [5,1], [4,1], [1,5]],
    cast: ['bulldog', 'eagle', 'seminole', 'gamecock', 'smokey', 'ibis', 'wildcat', 'tiger', 'bull', 'longhorn'],
    pellets: [[5,4], [3,4], [2,3], [2,1], [3,0], [5,0], [6,1], [5,2], [4,3], [2,0]] },
  { num: 37, quizId: 'chomp-9-13-26', live: '2026-09-13', dateLabel: 'September 13, 2026', sunday: true, w: 7, h: 7, start: [4,2], floor: 27, min: 39, walls: [[3,5], [3,0], [5,4], [5,5], [5,1], [0,4], [1,1]],
    cast: ['bulldog', 'gamecock', 'eagle', 'ibis', 'bull', 'tiger', 'seminole', 'longhorn', 'knight', 'smokey', 'wildcat'],
    pellets: [[3,3], [4,4], [2,4], [2,2], [1,3], [1,5], [0,6], [2,6], [5,6], [5,3], [0,3]] },
  { num: 38, quizId: 'chomp-9-14-26', live: '2026-09-14', dateLabel: 'September 14, 2026', sunday: false, w: 7, h: 7, start: [4,2], floor: 18, min: 30, walls: [[4,5], [0,4], [1,5], [5,3], [3,5], [5,4], [5,5]],
    cast: ['bulldog', 'ibis', 'smokey', 'wildcat', 'longhorn', 'tiger', 'knight', 'eagle'],
    pellets: [[2,2], [1,3], [0,2], [1,1], [2,0], [3,1], [4,0], [3,3]] },
  { num: 39, quizId: 'chomp-9-15-26', live: '2026-09-15', dateLabel: 'September 15, 2026', sunday: false, w: 7, h: 7, start: [5,1], floor: 19, min: 33, walls: [[4,1], [1,4], [5,5], [1,1], [1,3], [3,2], [1,6]],
    cast: ['bulldog', 'seminole', 'tiger', 'smokey', 'bull', 'ibis', 'knight', 'gamecock'],
    pellets: [[4,2], [5,3], [4,4], [3,3], [2,2], [0,2], [2,1], [2,5]] },
  { num: 40, quizId: 'chomp-9-16-26', live: '2026-09-16', dateLabel: 'September 16, 2026', sunday: false, w: 7, h: 7, start: [5,4], floor: 22, min: 36, walls: [[2,1], [2,5], [5,1], [1,5], [1,3]],
    cast: ['bulldog', 'smokey', 'gamecock', 'knight', 'longhorn', 'eagle', 'wildcat', 'ibis', 'seminole'],
    pellets: [[4,5], [3,4], [2,3], [3,2], [4,3], [5,2], [6,1], [4,1], [6,5]] },
  { num: 41, quizId: 'chomp-9-17-26', live: '2026-09-17', dateLabel: 'September 17, 2026', sunday: false, w: 7, h: 7, start: [3,3], floor: 23, min: 35, walls: [[4,5], [1,3], [2,1], [1,5], [5,3], [1,2], [2,5]],
    cast: ['bulldog', 'knight', 'bull', 'gamecock', 'eagle', 'seminole', 'smokey', 'tiger', 'wildcat'],
    pellets: [[3,5], [4,6], [6,6], [5,5], [4,4], [4,2], [5,1], [2,2], [6,3]] },
  { num: 42, quizId: 'chomp-9-18-26', live: '2026-09-18', dateLabel: 'September 18, 2026', sunday: false, w: 7, h: 7, start: [0,6], floor: 24, min: 38, walls: [[0,2], [0,0], [1,4], [4,4], [3,4], [1,5]],
    cast: ['bulldog', 'bull', 'wildcat', 'ibis', 'knight', 'eagle', 'longhorn', 'smokey', 'tiger'],
    pellets: [[2,6], [2,4], [3,3], [2,2], [3,1], [5,1], [4,3], [4,6], [0,4]] },
  { num: 43, quizId: 'chomp-9-19-26', live: '2026-09-19', dateLabel: 'September 19, 2026', sunday: false, w: 7, h: 7, start: [2,4], floor: 22, min: 40, walls: [[5,0], [2,1], [4,0], [1,1], [1,4]],
    cast: ['bulldog', 'eagle', 'bull', 'wildcat', 'smokey', 'longhorn', 'ibis', 'seminole', 'gamecock', 'knight'],
    pellets: [[1,3], [2,2], [3,3], [5,3], [5,5], [4,4], [2,5], [0,5], [1,6], [0,4]] },
  { num: 44, quizId: 'chomp-9-20-26', live: '2026-09-20', dateLabel: 'September 20, 2026', sunday: true, w: 7, h: 7, start: [1,3], floor: 27, min: 39, walls: [[5,4], [6,6], [1,5], [1,4], [2,1], [0,0], [2,3]],
    cast: ['bulldog', 'eagle', 'gamecock', 'longhorn', 'bull', 'smokey', 'ibis', 'knight', 'seminole', 'tiger', 'wildcat'],
    pellets: [[2,2], [3,3], [2,4], [3,5], [4,4], [4,2], [3,1], [5,0], [6,1], [5,2], [1,0]] },
  { num: 45, quizId: 'chomp-9-21-26', live: '2026-09-21', dateLabel: 'September 21, 2026', sunday: false, w: 7, h: 7, start: [2,1], floor: 19, min: 31, walls: [[5,3], [4,0], [6,6], [1,2], [2,4], [6,1]],
    cast: ['bulldog', 'longhorn', 'bull', 'knight', 'gamecock', 'ibis', 'wildcat', 'tiger'],
    pellets: [[2,3], [3,2], [4,3], [3,4], [2,5], [3,6], [4,5], [1,3]] },
  { num: 46, quizId: 'chomp-9-22-26', live: '2026-09-22', dateLabel: 'September 22, 2026', sunday: false, w: 7, h: 7, start: [4,4], floor: 17, min: 35, walls: [[1,3], [5,6], [2,1], [5,2], [1,2]],
    cast: ['bulldog', 'ibis', 'longhorn', 'tiger', 'wildcat', 'seminole', 'knight', 'bull'],
    pellets: [[5,3], [4,2], [2,2], [2,4], [1,5], [2,6], [4,6], [1,6]] },
  { num: 47, quizId: 'chomp-9-23-26', live: '2026-09-23', dateLabel: 'September 23, 2026', sunday: false, w: 7, h: 7, start: [3,1], floor: 22, min: 34, walls: [[1,3], [4,3], [2,1], [0,5], [0,6], [3,4], [5,5]],
    cast: ['bulldog', 'seminole', 'knight', 'tiger', 'gamecock', 'ibis', 'smokey', 'eagle', 'wildcat'],
    pellets: [[2,2], [2,4], [3,5], [4,4], [5,3], [6,2], [5,1], [4,0], [6,4]] },
  { num: 48, quizId: 'chomp-9-24-26', live: '2026-09-24', dateLabel: 'September 24, 2026', sunday: false, w: 7, h: 7, start: [4,3], floor: 23, min: 37, walls: [[4,0], [3,5], [1,6], [3,3], [1,1]],
    cast: ['bulldog', 'wildcat', 'tiger', 'seminole', 'bull', 'gamecock', 'eagle', 'smokey', 'ibis'],
    pellets: [[5,2], [3,2], [1,2], [2,3], [3,4], [4,5], [5,4], [6,6], [6,0]] },
  { num: 49, quizId: 'chomp-9-25-26', live: '2026-09-25', dateLabel: 'September 25, 2026', sunday: false, w: 7, h: 7, start: [0,6], floor: 26, min: 38, walls: [[3,6], [4,5], [2,2], [6,6], [2,3], [3,5]],
    cast: ['bulldog', 'longhorn', 'tiger', 'smokey', 'gamecock', 'knight', 'eagle', 'seminole', 'bull'],
    pellets: [[1,5], [2,6], [2,4], [4,4], [5,3], [4,1], [3,2], [0,4], [5,5]] },
  { num: 50, quizId: 'chomp-9-26-26', live: '2026-09-26', dateLabel: 'September 26, 2026', sunday: false, w: 7, h: 7, start: [5,2], floor: 21, min: 39, walls: [[5,3], [2,1], [0,1], [1,3], [0,0], [2,3]],
    cast: ['bulldog', 'wildcat', 'eagle', 'longhorn', 'smokey', 'ibis', 'knight', 'seminole', 'gamecock', 'bull'],
    pellets: [[4,1], [3,2], [4,3], [5,4], [4,5], [3,4], [2,5], [1,4], [0,3], [0,6]] },
  { num: 51, quizId: 'chomp-9-27-26', live: '2026-09-27', dateLabel: 'September 27, 2026', sunday: true, w: 7, h: 7, start: [0,4], floor: 26, min: 40, walls: [[4,2], [3,6], [6,6], [2,1], [1,5], [1,1]],
    cast: ['bulldog', 'longhorn', 'ibis', 'gamecock', 'bull', 'seminole', 'tiger', 'smokey', 'wildcat', 'eagle', 'knight'],
    pellets: [[0,6], [2,6], [3,5], [4,4], [5,3], [5,1], [3,1], [2,2], [3,4], [1,4], [4,6]] },
  { num: 52, quizId: 'chomp-9-28-26', live: '2026-09-28', dateLabel: 'September 28, 2026', sunday: false, w: 7, h: 7, start: [5,1], floor: 20, min: 30, walls: [[4,1], [0,6], [2,5], [1,1], [1,6], [2,3], [1,0]],
    cast: ['bulldog', 'gamecock', 'seminole', 'eagle', 'ibis', 'bull', 'smokey', 'tiger'],
    pellets: [[4,2], [5,3], [4,4], [5,5], [4,6], [3,5], [2,4], [6,6]] },
  { num: 53, quizId: 'chomp-9-29-26', live: '2026-09-29', dateLabel: 'September 29, 2026', sunday: false, w: 7, h: 7, start: [3,1], floor: 20, min: 34, walls: [[2,4], [4,1], [1,3], [1,4], [6,4], [2,2], [5,2]],
    cast: ['bulldog', 'tiger', 'smokey', 'eagle', 'ibis', 'knight', 'wildcat', 'seminole'],
    pellets: [[4,2], [3,3], [4,4], [3,5], [2,6], [1,5], [0,6], [6,6]] },
  { num: 54, quizId: 'chomp-9-30-26', live: '2026-09-30', dateLabel: 'September 30, 2026', sunday: false, w: 7, h: 7, start: [0,3], floor: 23, min: 35, walls: [[4,4], [1,4], [2,2], [3,4], [3,5], [1,3]],
    cast: ['bulldog', 'wildcat', 'gamecock', 'ibis', 'tiger', 'seminole', 'smokey', 'knight', 'bull'],
    pellets: [[1,2], [2,1], [3,2], [4,1], [5,2], [3,3], [2,4], [1,5], [0,0]] },
  { num: 55, quizId: 'chomp-10-1-26', live: '2026-10-01', dateLabel: 'October 1, 2026', sunday: false, w: 7, h: 7, start: [5,4], floor: 25, min: 35, walls: [[1,5], [5,2], [4,1], [1,4], [3,5], [5,5], [2,2]],
    cast: ['bulldog', 'seminole', 'smokey', 'gamecock', 'wildcat', 'tiger', 'bull', 'ibis', 'eagle'],
    pellets: [[4,3], [3,2], [2,3], [1,2], [2,1], [1,0], [0,3], [2,4], [5,1]] },
  { num: 56, quizId: 'chomp-10-2-26', live: '2026-10-02', dateLabel: 'October 2, 2026', sunday: false, w: 7, h: 7, start: [5,5], floor: 18, min: 38, walls: [[3,5], [1,3], [1,6], [3,3], [1,0], [5,6]],
    cast: ['bulldog', 'ibis', 'smokey', 'wildcat', 'eagle', 'bull', 'tiger', 'longhorn', 'knight'],
    pellets: [[5,3], [4,2], [5,1], [3,1], [2,2], [2,4], [4,4], [4,6], [6,6]] },
  { num: 57, quizId: 'chomp-10-3-26', live: '2026-10-03', dateLabel: 'October 3, 2026', sunday: false, w: 7, h: 7, start: [3,1], floor: 23, min: 39, walls: [[3,3], [0,1], [5,0], [6,0], [5,1], [1,3]],
    cast: ['bulldog', 'eagle', 'tiger', 'ibis', 'longhorn', 'smokey', 'seminole', 'gamecock', 'bull', 'knight'],
    pellets: [[2,2], [2,4], [1,5], [0,6], [2,6], [3,5], [4,3], [5,4], [4,5], [1,4]] },
  { num: 58, quizId: 'chomp-10-4-26', live: '2026-10-04', dateLabel: 'October 4, 2026', sunday: true, w: 7, h: 7, start: [4,4], floor: 27, min: 41, walls: [[2,2], [1,0], [1,2], [0,6], [0,4]],
    cast: ['bulldog', 'smokey', 'eagle', 'knight', 'wildcat', 'gamecock', 'bull', 'tiger', 'seminole', 'ibis', 'longhorn'],
    pellets: [[4,2], [5,1], [3,1], [3,3], [2,4], [3,5], [2,6], [4,5], [5,6], [5,4], [0,5]] },
  { num: 59, quizId: 'chomp-10-5-26', live: '2026-10-05', dateLabel: 'October 5, 2026', sunday: false, w: 7, h: 7, start: [3,5], floor: 21, min: 31, walls: [[4,3], [2,2], [6,4], [2,5], [3,0], [1,3]],
    cast: ['bulldog', 'wildcat', 'smokey', 'tiger', 'ibis', 'knight', 'longhorn', 'gamecock'],
    pellets: [[4,4], [2,4], [3,3], [3,1], [2,0], [0,1], [1,2], [5,0]] },
  { num: 60, quizId: 'chomp-10-6-26', live: '2026-10-06', dateLabel: 'October 6, 2026', sunday: false, w: 7, h: 7, start: [4,5], floor: 19, min: 35, walls: [[6,5], [1,2], [3,1], [2,0], [5,3]],
    cast: ['bulldog', 'gamecock', 'wildcat', 'bull', 'longhorn', 'eagle', 'smokey', 'tiger'],
    pellets: [[2,5], [1,4], [2,3], [3,2], [4,3], [5,2], [4,1], [0,0]] },
  { num: 61, quizId: 'chomp-10-7-26', live: '2026-10-07', dateLabel: 'October 7, 2026', sunday: false, w: 7, h: 7, start: [0,1], floor: 24, min: 34, walls: [[5,0], [3,4], [2,2], [4,4], [3,1], [4,0], [5,2]],
    cast: ['bulldog', 'bull', 'wildcat', 'eagle', 'knight', 'tiger', 'ibis', 'smokey', 'longhorn'],
    pellets: [[1,0], [2,1], [1,2], [0,3], [1,4], [2,5], [4,5], [3,2], [1,6]] },
  { num: 62, quizId: 'chomp-10-8-26', live: '2026-10-08', dateLabel: 'October 8, 2026', sunday: false, w: 7, h: 7, start: [4,3], floor: 23, min: 35, walls: [[1,4], [3,3], [2,5], [5,2], [0,6], [1,2], [5,5]],
    cast: ['bulldog', 'longhorn', 'ibis', 'knight', 'tiger', 'seminole', 'bull', 'smokey', 'gamecock'],
    pellets: [[5,4], [4,5], [3,4], [2,3], [2,1], [3,0], [3,2], [4,0], [1,3]] },
  { num: 63, quizId: 'chomp-10-9-26', live: '2026-10-09', dateLabel: 'October 9, 2026', sunday: false, w: 7, h: 7, start: [2,4], floor: 24, min: 36, walls: [[0,3], [2,5], [5,5], [5,4], [5,3], [0,4], [3,1]],
    cast: ['bulldog', 'smokey', 'eagle', 'longhorn', 'wildcat', 'knight', 'ibis', 'gamecock', 'bull'],
    pellets: [[4,4], [4,2], [3,3], [2,2], [1,3], [0,5], [1,6], [3,5], [0,2]] },
  { num: 64, quizId: 'chomp-10-10-26', live: '2026-10-10', dateLabel: 'October 10, 2026', sunday: false, w: 7, h: 7, start: [3,2], floor: 22, min: 38, walls: [[5,2], [4,2], [4,4], [4,0], [4,3], [6,4]],
    cast: ['bulldog', 'smokey', 'knight', 'eagle', 'longhorn', 'bull', 'gamecock', 'seminole', 'ibis', 'wildcat'],
    pellets: [[3,4], [2,5], [1,4], [2,3], [1,2], [2,1], [3,0], [4,1], [5,0], [1,0]] },
  { num: 65, quizId: 'chomp-10-11-26', live: '2026-10-11', dateLabel: 'October 11, 2026', sunday: true, w: 7, h: 7, start: [5,6], floor: 26, min: 40, walls: [[4,1], [4,2], [4,6], [5,5], [6,3], [2,5]],
    cast: ['bulldog', 'ibis', 'eagle', 'tiger', 'wildcat', 'bull', 'knight', 'longhorn', 'gamecock', 'seminole', 'smokey'],
    pellets: [[6,5], [5,4], [3,4], [1,4], [2,3], [1,2], [2,1], [3,2], [6,2], [5,1], [4,5]] },
  { num: 66, quizId: 'chomp-10-12-26', live: '2026-10-12', dateLabel: 'October 12, 2026', sunday: false, w: 7, h: 7, start: [1,0], floor: 20, min: 30, walls: [[5,5], [5,1], [6,0], [1,5], [2,4], [3,6], [1,4]],
    cast: ['bulldog', 'ibis', 'gamecock', 'seminole', 'longhorn', 'tiger', 'knight', 'eagle'],
    pellets: [[2,1], [3,2], [2,3], [3,4], [5,4], [4,3], [5,2], [0,3]] },
  { num: 67, quizId: 'chomp-10-13-26', live: '2026-10-13', dateLabel: 'October 13, 2026', sunday: false, w: 7, h: 7, start: [4,2], floor: 19, min: 35, walls: [[1,2], [2,6], [6,2], [2,1], [4,5]],
    cast: ['bulldog', 'ibis', 'bull', 'gamecock', 'tiger', 'eagle', 'knight', 'wildcat'],
    pellets: [[3,1], [2,2], [2,4], [3,3], [4,4], [5,5], [2,5], [6,5]] },
  { num: 68, quizId: 'chomp-10-14-26', live: '2026-10-14', dateLabel: 'October 14, 2026', sunday: false, w: 7, h: 7, start: [6,3], floor: 22, min: 34, walls: [[5,3], [2,5], [0,1], [4,2], [0,6], [3,2], [1,3]],
    cast: ['bulldog', 'knight', 'wildcat', 'eagle', 'longhorn', 'gamecock', 'ibis', 'smokey', 'tiger'],
    pellets: [[5,4], [4,3], [3,4], [2,3], [2,1], [4,1], [5,2], [5,0], [4,5]] },
  { num: 69, quizId: 'chomp-10-15-26', live: '2026-10-15', dateLabel: 'October 15, 2026', sunday: false, w: 7, h: 7, start: [5,4], floor: 22, min: 36, walls: [[5,3], [5,2], [3,1], [2,4], [5,5], [1,1]],
    cast: ['bulldog', 'bull', 'smokey', 'knight', 'eagle', 'ibis', 'longhorn', 'tiger', 'gamecock'],
    pellets: [[4,5], [3,4], [4,3], [3,2], [2,3], [1,4], [0,5], [2,6], [1,2]] },
  { num: 70, quizId: 'chomp-10-16-26', live: '2026-10-16', dateLabel: 'October 16, 2026', sunday: false, w: 7, h: 7, start: [5,3], floor: 24, min: 38, walls: [[2,4], [6,2], [0,0], [4,5], [4,3]],
    cast: ['bulldog', 'smokey', 'gamecock', 'tiger', 'knight', 'longhorn', 'seminole', 'wildcat', 'eagle'],
    pellets: [[6,4], [5,5], [4,4], [3,5], [1,5], [3,3], [4,2], [6,1], [6,6]] },
];
