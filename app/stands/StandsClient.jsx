      ...
      <div className="bk-wrap" style={{ position: 'relative', zIndex: 2, maxWidth: 1180, margin: '0 auto', padding: '18px 38px 80px', fontFamily: SANS }}>
        ...
        {started && (
          <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', margin: '8px 0' }}>
            ...
            <button type="button" className="bk-btn" onClick={hint} style={{ background: COLORS.accentSoft, borderColor: 'rgba(37,99,235,0.45)', color: COLORS.accentDeep }}><Lightbulb size={14} /> Nudge (−2)</button>
