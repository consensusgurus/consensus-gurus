      ...
      <div className="loft-back">
        <div className="loft-backin">
          <style>{`
            ...
            .d5f-run.circ .d5f-eye{color:#2f6fe4;}
            ...
            .d5f-pips span.now{background:#2f6fe4;}
            ...
            .loft-next.d5f-retry{background:rgba(47,111,228,.10);width:100%;text-align:left;
              border:0;font-family:inherit;cursor:pointer;}
            .loft-next.d5f-retry:hover{background:rgba(47,111,228,.16);}
            .loft-next.d5f-retry .go{background:#2f6fe4;}
        ...
        <div className="loft-backin">
          <style>{`
            ...
            .lfr-go{display:flex;align-items:center;gap:11px;width:100%;padding:12px 13px;
              border-radius:11px;background:rgba(47,111,228,.10);
              border:2px solid rgba(47,111,228,.32);color:var(--ink);
              font-family:inherit;text-align:left;cursor:pointer;}
            .lfr-go:hover{background:rgba(47,111,228,.17);}
            .lfr-t{flex:1;min-width:0;}
            .lfr-eb{display:block;font-weight:800;font-size:9.5px;line-height:1;
              letter-spacing:.11em;text-transform:uppercase;color:#2563eb;margin-bottom:5px;}
            ...
            .lfr-chip{flex:none;background:#2f6fe4;color:#fff;border-radius:10px;
    ...
    <div className="loft-back">
      ...
      {claimBandShown ? (
        <div className="loft-claim">
          <style>{`
            .loft-claim{margin:2px 0 10px;border:2px solid rgba(47,111,228,.32);border-radius:11px;
              background:rgba(47,111,228,.07);padding:11px 13px;}
            ...
            .loft-claim .go{flex:none;border:0;background:#2f6fe4;color:#fff;border-radius:9px;
              padding:9px 13px;font-family:inherit;font-weight:800;font-size:12.5px;cursor:pointer;}
            .loft-claim .go:hover{background:#2563eb;}
