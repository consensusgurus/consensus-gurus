...
function iconDataURI() {
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="160" height="160" viewBox="0 0 120 120"><path d="M20 52l40-34 40 34" stroke="#0b0d12" stroke-width="7" stroke-linecap="round" stroke-linejoin="round" fill="none"/><path d="M14 102h92" stroke="#0b0d12" stroke-width="6" stroke-linecap="round"/><g transform="translate(31,48) scale(0.53)"><path d="M14 42C12 28 22 16 36 16C40 8 54 6 60 14C70 8 84 14 86 26C96 30 98 44 88 50C92 58 86 66 76 64C74 72 64 74 60 66C48 70 36 66 32 56C20 56 12 50 14 42Z" fill="#2f6fe4"/></g></svg>`;
    ...
    h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: '#f7f8fa', fontFamily: 'Manrope', position: 'relative' } }, [
      ...
      h('div', { key: 'head', style: { display: 'flex', alignItems: 'center', marginTop: '-8px' } }, [
        ...
        h('div', { key: 'hd', style: { display: 'flex', flexDirection: 'column', marginLeft: '22px' } }, [
          T('MIND LOFT', { fontSize: 30, fontWeight: 800, letterSpacing: '6px', color: '#233a63' }),
          T('PLAYER PROFILE', { fontSize: 22, fontWeight: 700, letterSpacing: '8px', color: '#233a63', marginTop: '6px' }),
        ]),
      ]),
      T(name, { fontSize: name.length > 14 ? 76 : 96, fontWeight: 800, letterSpacing: '-2px', color: '#0b0d12', marginTop: '18px', maxWidth: '1100px' }),
      tier
      ...
      statBits.length
        ? T(statBits.join('  ·  '), { fontSize: 32, fontWeight: 800, letterSpacing: '2px', color: '#ffffff', background: '#233a63', borderRadius: '999px', padding: '16px 40px', marginTop: '26px' })
        : T('DAILY PUZZLES · QUIZZES · TROPHIES', { fontSize: 30, fontWeight: 700, letterSpacing: '3px', color: '#ffffff', background: '#233a63', borderRadius: '999px', padding: '16px 40px', marginTop: '26px' }),
      T('PLAY FREE · MINDLOFTDAILY.COM', { fontSize: 24, fontWeight: 800, letterSpacing: '4px', color: '#233a63', marginTop: '24px' }),
    ]),
    { ...size, fonts },
  );
}
