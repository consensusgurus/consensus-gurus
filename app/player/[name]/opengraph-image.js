    ...
    h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: '#fbfaf9', fontFamily: 'Manrope', position: 'relative' } }, [
      ...
      h('div', { key: 'head', style: { display: 'flex', alignItems: 'center', marginTop: '-8px' } }, [
        ...
        h('div', { key: 'hd', style: { display: 'flex', flexDirection: 'column', marginLeft: '22px' } }, [
          T('MIND LOFT', { fontSize: 30, fontWeight: 800, letterSpacing: '6px', color: '#3a4152' }),
          T('PLAYER PROFILE', { fontSize: 22, fontWeight: 700, letterSpacing: '8px', color: '#3a4152', marginTop: '6px' }),
        ]),
      ]),
      ...
      statBits.length
        ? T(statBits.join('  ·  '), { fontSize: 32, fontWeight: 800, letterSpacing: '2px', color: '#ffffff', background: '#3a4152', borderRadius: '999px', padding: '16px 40px', marginTop: '26px' })
        : T('DAILY PUZZLES · QUIZZES · TROPHIES', { fontSize: 30, fontWeight: 700, letterSpacing: '3px', color: '#ffffff', background: '#3a4152', borderRadius: '999px', padding: '16px 40px', marginTop: '26px' }),
      T('PLAY FREE · MINDLOFTDAILY.COM', { fontSize: 24, fontWeight: 800, letterSpacing: '4px', color: '#3a4152', marginTop: '24px' }),
    ]),
    { ...size, fonts },
  );
}
