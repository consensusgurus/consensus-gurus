...
export const DAILY_GAMES = [
  { key: 'crux', href: '/crux', name: 'Crux', tag: 'a clueless crossword', store: 'sot_crux_day', accent: T.blue, bg: '#eef4ff', border: 'rgba(192,74,52,0.35)' },
  ...
  { key: 'stands', href: '/stands', name: 'Stands', tag: 'rebuild the results', store: 'sot_stands_day', accent: T.blueDeep, bg: '#e8effd', border: 'rgba(168,63,40,0.35)' },
  ...
  { key: 'four', href: '/four', name: 'Four', tag: 'one column wins', store: 'sot_four_day', accent: T.blueDark, bg: '#e8eefc', border: 'rgba(58,65,82,0.35)' },
  ...
  { key: 'blocks', href: '/blocks', name: 'Blocks', tag: 'same shapes, same order', store: 'sot_blocks_day', accent: '#a83f28', bg: '#e8edfa', border: 'rgba(168,63,40,0.4)' },
