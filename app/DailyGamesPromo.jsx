...
export const DAILY_GAMES = [
  { key: 'crux', href: '/crux', name: 'Crux', tag: 'a clueless crossword', store: 'sot_crux_day', accent: T.blue, bg: '#f4f6f9', border: 'rgba(192,74,52,0.35)' },
  ...
  { key: 'outrank', href: '/outrank', name: 'Outrank', tag: "call the crowd's order", store: 'sot_outrank_day', accent: '#4338ca', bg: '#f3f3f6', border: 'rgba(67,56,202,0.4)' },
  ...
  { key: 'stands', href: '/stands', name: 'Stands', tag: 'rebuild the results', store: 'sot_stands_day', accent: T.blueDeep, bg: '#f0f2f5', border: 'rgba(168,63,40,0.35)' },
  ...
  { key: 'four', href: '/four', name: 'Four', tag: 'one column wins', store: 'sot_four_day', accent: T.blueDark, bg: '#eff1f5', border: 'rgba(58,65,82,0.35)' },
  ...
  { key: 'suffice', href: '/suffice', name: 'Suffice', tag: 'decide what is enough', store: 'sot_suffice_day', accent: '#4338ca', bg: '#f4f5f9', border: 'rgba(67,56,202,0.4)' },
  ...
  { key: 'blocks', href: '/blocks', name: 'Blocks', tag: 'same shapes, same order', store: 'sot_blocks_day', accent: '#a83f28', bg: '#eff0f3', border: 'rgba(168,63,40,0.4)' },
  ...
  { key: 'sixes', href: '/sixes', name: 'Sixes', tag: 'the daily mini sudoku', store: 'sot_sixes_day', accent: '#a83f28', bg: '#fdf2ef', border: 'rgba(168,63,40,0.4)' },
