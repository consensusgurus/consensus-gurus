...
export const metadata = {
  ...
  description:
    'A free daily logic deduction game — four suspects, four rooms, four departure times, four curious items. Every witness statement is true; work the deduction boards and close the case. A new mystery every day.',
...
const gameJsonLd = {
  ...
  description:
    'A free daily Einstein-style logic puzzle dressed as a whodunit: four suspects, four rooms, four departure times, four items. Every witness statement is true, and each case is machine-verified to have exactly one solution — pure deduction closes it.',
