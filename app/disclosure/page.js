...
export const metadata = {
  title: 'Affiliate Disclosure | Consensus Gurus',
  description: 'How Consensus Gurus makes money through affiliate partnerships.',
};
...
export default function DisclosurePage() {
  return (
    ...
    >
      <p>
        Consensus Gurus participates in affiliate marketing programs. This page exists to be transparent about that.
      </p>

      <H2>Amazon Associates</H2>
      <p>
        Consensus Gurus is a participant in the Amazon Services LLC Associates Program, an affiliate advertising program designed to provide a means for sites to earn advertising fees by advertising and linking to amazon.com and affiliated sites.
      </p>
      <p>
        <strong>As an Amazon Associate, Consensus Gurus earns from qualifying purchases.</strong>
      </p>
      <p>
      ...
      <H2>Questions</H2>
      <p>
        If you have any questions about how the site makes money, contact us at <strong>hello@your-domain.com</strong>.
      </p>
    </LegalLayout>
  );
}
