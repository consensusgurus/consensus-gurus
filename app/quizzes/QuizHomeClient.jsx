...
export default function QuizHomeClient({ variant = 'current' }) {
  ...
  const css = `
    ...
    .qzh .ttile-ov{position:relative;z-index:1;padding:18px 16px 15px;background:linear-gradient(to top, rgba(25,27,38,0.9), rgba(25,27,38,0.45) 55%, rgba(25,27,38,0));}
    ...
    .qzh .rmeter{position:absolute;left:0;top:0;bottom:0;z-index:0;min-width:3px;background:linear-gradient(90deg,rgba(192,74,52,.16),rgba(192,74,52,.05));border-right:2px solid var(--blue);border-radius:7px 0 0 7px;}
   ...
   across neighbouring columns with no ragged end gap. cover = crop, no stretch. */
    ...
    .qzh .cc-ov{position:absolute;inset:0;background:linear-gradient(to top, rgba(25,27,38,0.92), rgba(25,27,38,0.4) 52%, rgba(25,27,38,0.05));z-index:1;}
...
function CategoryMasteryTile({ rows, onPick, colorFor }) {
  ...
  return (
    <section className="mc-open catcard cmt" style={{ minWidth: 0, '--cc': T.blue, '--cct': '#fdf2ef' }}>
      <style>{`
