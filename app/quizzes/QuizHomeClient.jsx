...
const DAILY_GAME_FAMILY_RE = /^(crux|emcee|garble|links|span|dating|tally|suds|circa|extra|carve|stet|outwit|tuck|alibi|cipher|ping|warmer|jester|sworn|closer|outrank|shards)-/;
...
const DG_HERO_FAMS = new Set(['alibi', 'carve', 'cipher', 'circa', 'crux', 'dating', 'emcee', 'extra',
  'garble', 'jester', 'links', 'outwit', 'outrank', 'ping', 'span', 'stet', 'suds', 'sworn', 'tally', 'tuck', 'warmer', 'shards']);
...
const NEWEST_BN_ALLOW = new Set(['netflix-2q26-earnings-quiz', 'tesla-2q26-earnings-quiz', 'alphabet-2q26-earnings-quiz', 'intel-2q26-earnings-quiz']);
