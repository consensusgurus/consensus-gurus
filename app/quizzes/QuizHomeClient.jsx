...
// Daily-game quizzes are date/topic-stamped (crux-*, garble-*, links-*, span-*, dating-*,
...
const DAILY_GAME_FAMILY_RE = /^(crux|garble|links|span|dating|tally|suds|circa|extra|carve|closer)-/;
function gameFamily(id) { const m = (id || '').match(DAILY_GAME_FAMILY_RE); return m ? m[1] : null; }
// Rule: daily games (Crux, Garble, Links, Span, Dating, Tally, Suds, Circa, Extra, Carve, Closer) publish a fresh
