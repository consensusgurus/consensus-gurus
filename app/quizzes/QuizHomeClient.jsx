...
// tally-*, suds-*, circa-*, extra-*, carve-*, stet-*, outwit-*, tuck-*, alibi-*, cipher-*, ping-*, closer-*) and every entry in a family shares ONE hero image, so the two hero
// tiles (Newest + Trending) must never both draw from the same family.
const DAILY_GAME_FAMILY_RE = /^(crux|emcee|garble|links|span|dating|tally|suds|circa|extra|carve|stet|outwit|tuck|alibi|cipher|ping|warmer|closer)-/;
