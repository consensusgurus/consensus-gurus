...
const DAILY_GAME_FAMILY_RE = /^(crux|emcee|garble|links|span|dating|tally|suds|circa|extra|carve|stet|outwit|tuck|alibi|cipher|ping|warmer|jester|sworn|closer|outrank)-/;
...
const DG_HERO_FAMS = new Set(['alibi', 'carve', 'cipher', 'circa', 'crux', 'dating', 'emcee', 'extra',
  'garble', 'jester', 'links', 'outwit', 'outrank', 'ping', 'span', 'stet', 'suds', 'sworn', 'tally', 'tuck', 'warmer']);
...
export default function QuizHomeClient() {
  ...
  const css = `
    ...
    .qzh .dtile-cta-ldr{display:inline-flex;align-items:center;gap:6px;min-width:0;flex:1;justify-content:flex-end;padding-left:10px;border-left:1px solid rgba(28,30,36,0.25);}
