          ...
          <LoftFinish
            ...
            gameRank={allTime && allTime.ready
              ? { value: allTime.rank != null ? `#${allTime.rank}` : '\u2014',
                  label: allTime.field != null ? `listed of ${allTime.field}` : 'listed all time' }
              : null}
            day={dayStats}
            ...
            options={[
              { label: 'See the board', sub: 'The real ranking beside yours', kind: 'pri', onClick: () => setRevealed(true) },
