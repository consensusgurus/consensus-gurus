...
export default function GridFillBoard({ quizId }) {
  ...
  function Block({ col }) {
    return (
      <div style={{ flex: '0 0 calc(20% - 8px)', minWidth: 132, background: COLORS.paper, border: `1px solid ${COLORS.faded}44`, borderRadius: 4, padding: '6px 7px 4px' }}>
          ...
          <>
            ...
            {(phase === 'playing' || phase === 'done') && (
              <div>
                ...
                {phase === 'done' && (
                  <div style={{ padding: 24, border: `1.5px solid ${COLORS.ink}`, background: COLORS.paper, textAlign: 'center', marginTop: 18 }}>
            ...
            {qSent ? (
              ...
              <>
                ...
                <div style={{ display: 'flex', gap: 10, justifyContent: 'flex-end' }}>
                  ...
                  <button onClick={submitQuestion} disabled={qBusy} style={{ cursor: 'pointer', background: COLORS.ember, color: '#fff', border: `1.5px solid ${COLORS.ember}`, padding: '10px 18px', fontFamily: MONO, fontSize: 11, letterSpacing: '0.14em', textTransform: 'uppercase', fontWeight: 700, opacity: qBusy ? 0.6 : 1 }}>{qBusy ? 'Sending…' : 'Send to editors'}</button>
                </div>
              </>
            )}
          </div>
