  ...
  return (
    <div id="daily-leaderboard" className="dbp" style={{ maxWidth, margin: '18px auto 26px' }}>
      <style>{`
        ...
        .dbp-tile:hover{border-color:${BLUE};box-shadow:0 5px 18px rgba(47,111,228,.16);transform:translateY(-1px);}
        .dbp-tile.on{border-color:${BLUE};box-shadow:0 0 0 1px ${BLUE},0 5px 18px rgba(47,111,228,.16);}
