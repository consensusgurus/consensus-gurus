...
const GAME_NAMES = {
  crux: 'Crux', garble: 'Garble', links: 'Links', span: 'Span', dating: 'Dating',
  tally: 'Tally', suds: 'Suds', circa: 'Circa', extra: 'Extra', carve: 'Carve',
};
// Per-game accent for the game-board title. Light = the games' own (darker)
// colors; navy = lightened for legibility on the dark card.
const ACCENTS_LIGHT = { crux: '#2563eb', garble: '#8a6d1a', links: '#166534', span: '#9d174d', dating: '#6d28d9', tally: '#15803d', suds: '#ea580c', circa: '#0e7490', extra: '#b91c1c', carve: '#7c3aed' };
const ACCENTS_NAVY = { crux: '#5b9bff', garble: '#f0c95a', links: '#4ca878', span: '#e06aa0', dating: '#a483f0', tally: '#4cb377', suds: '#f0894c', circa: '#38b6cf', extra: '#e06a6a', carve: '#a483f0' };
