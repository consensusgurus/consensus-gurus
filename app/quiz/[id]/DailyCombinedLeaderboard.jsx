...
function theme(light) {
  if (light) return {
    ...
    name: T.ink, nameDot: '#4d4a5288', you: T.muted,
  ...
  return {
    light: false,
    card: 'linear-gradient(165deg,#16294f,#0c1a34)', cardBorder: 'rgba(224,174,74,0.28)', boxShadow: '0 10px 30px rgba(10,18,38,0.25)',
    label: T.gold, labelWeight: 800, sub: '#93a7cc',
    line: 'rgba(255,255,255,0.09)',
    row: 'rgba(255,255,255,0.045)', topRow: 'rgba(224,174,74,0.08)', topBorder: 'rgba(224,174,74,0.22)',
    meRow: 'rgba(224,174,74,0.16)', meBorder: 'rgba(224,174,74,0.55)',
    ...
    expandColor: '#f5d878', expandBorder: 'rgba(224,174,74,0.45)',
