...
function theme(light) {
  if (light) return {
    ...
    label: '#4b5563', labelWeight: 700, sub: '#4b5563',
    line: 'rgba(20,22,28,0.16)',
    row: '#fff', topRow: '#fff', topBorder: 'rgba(20,22,28,0.16)',
    meRow: '#eef3ff', meBorder: '#cddffb',
    rankTop: '#0e1d40', rankOther: '#4b5563',
    name: '#1c1e24', nameDot: '#4b556388', you: '#4b5563',
    dim: '#4b5563', total: '#1c1e24', unit: '#4b5563',
    tabOnText: '#fff', tabOffBg: '#fff', tabOffText: '#4b5563',
    expandColor: '#0e1d40', expandBorder: '#cddffb',
    note: '#4b5563', empty: '#4b5563',
