  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: 12 }}>
      {items.map((rq, i) => {
        ...
        return (
          <a key={rq.id} href={`/quiz/${rq.id}`} style={{ position: 'relative', display: 'block', textDecoration: 'none', borderRadius: 12, overflow: 'hidden', border: '1px solid rgba(20,22,28,0.09)', background: '#1c1e24', aspectRatio: '16 / 10', boxShadow: '0 1px 2px rgba(20,22,28,0.06)' }}>
