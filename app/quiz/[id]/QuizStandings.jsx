  ...
  return (
    <div className="qiq" style={outer}>
      <style>{`
        ...
        .qiq-rays{position:absolute;top:50%;left:50%;width:420px;height:420px;margin:-210px 0 0 -210px;pointer-events:none;opacity:0;background:radial-gradient(circle,rgba(192,74,52,.16) 0%,rgba(192,74,52,0) 62%);}
