...
const word = (t) => `<svg viewBox="0 0 100 100"><text x="50" y="51" font-size="${t.length > 7 ? 15 : t.length > 5 ? 18 : 22}" font-family="'Manrope', system-ui, sans-serif" font-weight="800" text-anchor="middle" dominant-baseline="central" fill="#1c1e24">${t}</text></svg>`;
...
const ITEMS = [
  ...
  ['House', '<svg viewBox="0 0 100 100"><path d="M20 46 L50 22 L80 46 Z" fill="#c0392b"/><rect x="28" y="46" width="44" height="34" fill="#e8b06a"/><rect x="44" y="58" width="12" height="22" fill="#7a4a22"/><rect x="33" y="52" width="9" height="9" fill="#bfe3f5"/><rect x="58" y="52" width="9" height="9" fill="#bfe3f5"/></svg>'],
  ...
  ['Ball', '<svg viewBox="0 0 100 100"><circle cx="50" cy="50" r="26" fill="#2f7be0"/><path d="M50 24 q14 26 0 52" stroke="#fff" stroke-width="3" fill="none"/><path d="M24 50 q26 -10 52 0" stroke="#fff" stroke-width="3" fill="none"/><circle cx="50" cy="50" r="26" fill="none" stroke="#1f5aa8" stroke-width="2"/></svg>'],
  ...
  ['Car', '<svg viewBox="0 0 100 100"><path d="M18 64 L24 50 Q28 44 38 44 L62 44 Q70 44 76 52 L82 64 Z" fill="#e23b3b"/><path d="M34 48 L60 48 L64 56 L30 56 Z" fill="#bfe3f5"/><rect x="16" y="62" width="68" height="8" rx="4" fill="#c0392b"/><circle cx="32" cy="70" r="8" fill="#2a2a2a"/><circle cx="68" cy="70" r="8" fill="#2a2a2a"/></svg>'],
