...
const ITEMS = [
  ...
  ['Ball', '<svg viewBox="0 0 100 100"><circle cx="50" cy="50" r="26" fill="#2f7be0"/><path d="M50 24 q14 26 0 52" stroke="#ffffff" stroke-width="3" fill="none"/><path d="M24 50 q26 -10 52 0" stroke="#ffffff" stroke-width="3" fill="none"/><circle cx="50" cy="50" r="26" fill="none" stroke="#1f5aa8" stroke-width="2"/></svg>'],
