...
const ITEMS = [
  ...
  ['House', '<svg viewBox="0 0 100 100"><path d="M20 46 L50 22 L80 46 Z" fill="#8f1d24"/><rect x="28" y="46" width="44" height="34" fill="#e8b06a"/><rect x="44" y="58" width="12" height="22" fill="#7a4a22"/><rect x="33" y="52" width="9" height="9" fill="#bfe3f5"/><rect x="58" y="52" width="9" height="9" fill="#bfe3f5"/></svg>'],
  ...
  ['Car', '<svg viewBox="0 0 100 100"><path d="M18 64 L24 50 Q28 44 38 44 L62 44 Q70 44 76 52 L82 64 Z" fill="#e23b3b"/><path d="M34 48 L60 48 L64 56 L30 56 Z" fill="#bfe3f5"/><rect x="16" y="62" width="68" height="8" rx="4" fill="#8f1d24"/><circle cx="32" cy="70" r="8" fill="#2a2a2a"/><circle cx="68" cy="70" r="8" fill="#2a2a2a"/></svg>'],
