...
const word = (t) => `<svg viewBox="0 0 100 100"><text x="50" y="52" font-size="22" font-family="'Manrope', system-ui, sans-serif" font-weight="800" text-anchor="middle" dominant-baseline="central" fill="#0b0d12">${t}</text></svg>`;
