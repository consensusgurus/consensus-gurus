...
const up = (t) => `<svg viewBox="0 0 100 100"><text x="50" y="53" font-size="56" font-family="'Manrope', system-ui, sans-serif" font-weight="800" text-anchor="middle" dominant-baseline="central" fill="#0b0d12">${t}</text></svg>`;
const lo = (t) => `<svg viewBox="0 0 100 100"><text x="50" y="53" font-size="56" font-family="'Manrope', system-ui, sans-serif" font-weight="800" text-anchor="middle" dominant-baseline="central" fill="#233a63">${t}</text></svg>`;
