...
const num = (t) => `<svg viewBox="0 0 100 100"><text x="50" y="51" font-size="46" font-family="'Manrope', system-ui, sans-serif" font-weight="800" text-anchor="middle" dominant-baseline="central" fill="#3a4152">${t}</text></svg>`;
