...
const num = (t) => `<svg viewBox="0 0 100 100"><text x="50" y="51" font-size="46" font-family="'Manrope', system-ui, sans-serif" font-weight="800" text-anchor="middle" dominant-baseline="central" fill={T.accent}>${t}</text></svg>`;
const word = (t) => `<svg viewBox="0 0 100 100"><text x="50" y="51" font-size="${t.length > 6 ? 17 : 21}" font-family="'Manrope', system-ui, sans-serif" font-weight="700" text-anchor="middle" dominant-baseline="central" fill=T.ink>${t}</text></svg>`;
