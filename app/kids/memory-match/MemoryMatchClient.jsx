...
const TREATS = [
  ...
  { n: 'French fries', s: '<svg viewBox="0 0 100 100"><g><rect x="38" y="22" width="7" height="40" rx="2" fill="#f2c14e"/><rect x="47" y="16" width="7" height="46" rx="2" fill="#f7cf63"/><rect x="56" y="24" width="7" height="38" rx="2" fill="#f2c14e"/><rect x="30" y="30" width="7" height="34" rx="2" fill="#f7cf63"/><rect x="64" y="32" width="7" height="32" rx="2" fill="#f2c14e"/><path d="M28 56 h44 l-6 28 h-32 z" fill="#e24b4a"/><rect x="34" y="62" width="32" height="8" fill={T.white} opacity="0.85"/></g></svg>' },
  { n: 'Ketchup', s: '<svg viewBox="0 0 100 100"><g><rect x="40" y="14" width="20" height="10" rx="3" fill="#a32d2d"/><rect x="36" y="24" width="28" height="60" rx="12" fill="#e24b4a"/><rect x="40" y="44" width="20" height="22" rx="4" fill={T.white}/><circle cx="50" cy="55" r="6" fill="#e24b4a"/></g></svg>' },
  { n: 'Popsicle', s: '<svg viewBox="0 0 100 100"><g><rect x="46" y="64" width="8" height="24" rx="3" fill="#c79a5b"/><rect x="32" y="16" width="36" height="56" rx="18" fill="#ef6ea0"/><rect x="38" y="22" width="8" height="18" rx="4" fill={T.white} opacity="0.5"/></g></svg>' },
  { n: 'Hot dog', s: '<svg viewBox="0 0 100 100"><g><rect x="16" y="40" width="68" height="22" rx="11" fill="#e7b96a"/><rect x="22" y="46" width="56" height="12" rx="6" fill={T.danger}/><path d="M26 52 q6 -6 12 0 q6 6 12 0 q6 -6 12 0 q6 6 10 0" fill="none" stroke="#f2c14e" stroke-width="3" stroke-linecap="round"/></g></svg>' },
  { n: 'Ice cream', s: '<svg viewBox="0 0 100 100"><g><path d="M38 50 h24 l-12 34 z" fill="#e0b070"/><path d="M42 56 l16 -8 M45 66 l13 -7" stroke="#c79a5b" stroke-width="2" fill="none"/><circle cx="50" cy="40" r="18" fill="#f7a6c4"/><circle cx="50" cy="22" r="4" fill={T.danger}/></g></svg>' },
  ...
  { n: 'Pizza', s: '<svg viewBox="0 0 100 100"><g><path d="M50 16 L78 78 H22 Z" fill="#f4d58a"/><path d="M22 78 H78 l-4 -9 H26 z" fill="#e0a85a"/><circle cx="44" cy="52" r="5" fill={T.danger}/><circle cx="58" cy="60" r="5" fill={T.danger}/><circle cx="50" cy="36" r="4" fill={T.danger}/></g></svg>' },
