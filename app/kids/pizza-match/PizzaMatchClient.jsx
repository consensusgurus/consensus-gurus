...
const PIZZAS = [
  ...
  { n: 'Margherita', s: `<svg viewBox="0 0 100 100">${BASE}<circle cx="40" cy="44" r="6" fill="#fff"/><circle cx="60" cy="56" r="6" fill="#fff"/><circle cx="53" cy="40" r="4" fill="#c0392b"/><circle cx="42" cy="60" r="4" fill="#c0392b"/><path d="M44 56 q4 -7 9 -3 q-4 7 -9 3z" fill="#4a7c2f"/><path d="M58 42 q4 -7 9 -3 q-4 7 -9 3z" fill="#4a7c2f"/></svg>` },
  ...
  { n: 'Pesto', s: `<svg viewBox="0 0 100 100"><circle cx="50" cy="50" r="40" fill="#e0a85a"/><circle cx="50" cy="50" r="33" fill="#7a9a4a"/><g fill="#e6dba0"><circle cx="42" cy="44" r="2.5"/><circle cx="58" cy="46" r="2.5"/><circle cx="48" cy="58" r="2.5"/><circle cx="61" cy="58" r="2.5"/></g><circle cx="52" cy="49" r="4.5" fill="#fff" opacity="0.85"/></svg>` },
