...
const PIZZAS = [
  ...
  { n: 'Pepperoni', s: `<svg viewBox="0 0 100 100">${BASE}<g fill={T.danger}><circle cx="40" cy="40" r="5.5"/><circle cx="60" cy="42" r="5.5"/><circle cx="50" cy="54" r="5.5"/><circle cx="38" cy="60" r="5.5"/><circle cx="62" cy="60" r="5.5"/></g></svg>` },
  { n: 'Margherita', s: `<svg viewBox="0 0 100 100">${BASE}<circle cx="40" cy="44" r="6" fill={T.white}/><circle cx="60" cy="56" r="6" fill={T.white}/><circle cx="53" cy="40" r="4" fill={T.danger}/><circle cx="42" cy="60" r="4" fill={T.danger}/><path d="M44 56 q4 -7 9 -3 q-4 7 -9 3z" fill="#4a7c2f"/><path d="M58 42 q4 -7 9 -3 q-4 7 -9 3z" fill="#4a7c2f"/></svg>` },
  ...
  { n: 'Veggie', s: `<svg viewBox="0 0 100 100">${BASE}<rect x="37" y="42" width="9" height="3.5" rx="1.7" fill="#3b8a3b"/><rect x="53" y="52" width="9" height="3.5" rx="1.7" fill={T.danger}/><rect x="44" y="58" width="9" height="3.5" rx="1.7" fill="#e8a72b" transform="rotate(38 48 60)"/><circle cx="58" cy="44" r="3" fill="#6a2c91"/><circle cx="39" cy="56" r="3" fill="#3b8a3b"/></svg>` },
  ...
  { n: 'Supreme', s: `<svg viewBox="0 0 100 100">${BASE}<circle cx="40" cy="42" r="4" fill={T.danger}/><rect x="54" y="43" width="6" height="3" rx="1.5" fill="#3b8a3b"/><circle cx="58" cy="57" r="3.4" fill="none" stroke="#222" stroke-width="2"/><circle cx="44" cy="58" r="3.6" fill="#8a5a2b"/><circle cx="50" cy="50" r="3" fill="#6a2c91"/><rect x="37" y="50" width="6" height="3" rx="1.5" fill="#e8a72b"/></svg>` },
  ...
  { n: 'Pesto', s: `<svg viewBox="0 0 100 100"><circle cx="50" cy="50" r="40" fill="#e0a85a"/><circle cx="50" cy="50" r="33" fill="#7a9a4a"/><g fill="#e6dba0"><circle cx="42" cy="44" r="2.5"/><circle cx="58" cy="46" r="2.5"/><circle cx="48" cy="58" r="2.5"/><circle cx="61" cy="58" r="2.5"/></g><circle cx="52" cy="49" r="4.5" fill={T.white} opacity="0.85"/></svg>` },
