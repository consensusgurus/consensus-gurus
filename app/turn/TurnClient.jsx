...
export default function TurnClient({ puzzles = [], forceNum = null }) {
  ...
  return (
    <div style={{ minHeight: '100vh', background: T.surface, position: 'relative' }}>
      <Grain />
      <DailyChrome slug="turn" name="Turn" collapsed={started} />
      <div className="tn-wrap" style={{ position: 'relative', zIndex: 2, maxWidth: 1180, margin: '0 auto', padding: '18px 38px 80px', fontFamily: SANS }}>
        ...
        <div style={{ maxWidth: 660, margin: '0 auto' }}>
          ...
          <DailyMasthead
            ...
            sunday={PUZZLE.sunday && <span style={{ fontFamily: MONO, fontSize: 9.5, letterSpacing: '0.1em', textTransform: 'uppercase', fontWeight: 500, color: T.white, background: COLORS.accent, borderRadius: 4, padding: '2px 6px' }}>Sunday Edition &middot; 12 squares</span>}
