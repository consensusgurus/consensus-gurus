...
import { PUZZLES as PARK_FULL } from '../unpark/puzzles';
...
const GAMES = [
  ...
  { key: 'park', name: 'Unpark', path: '/unpark', tag: 'Get the red one out', accent: '#7c5c2e', bg: '#f6efe2', border: 'rgba(124,92,46,0.35)', src: PARK },
