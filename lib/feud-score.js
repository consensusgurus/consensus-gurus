...
// Imported for LOCAL use (validBallot/cleanBallot call normAnswer) as well as
// re-exported: `export ... from` alone creates no local binding, so those two
// helpers threw a ReferenceError anywhere outside the Next bundle.
import { normAnswer, matchScore, tokensOf } from './feud-match';
export { normAnswer, matchScore, tokensOf };
