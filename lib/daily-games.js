...
const RAW = [
  ...
  { key: 'anon', miss: null, name: 'Anon', cat: 'Word', tag: 'A passage nobody signed', how: "An unsigned passage and a bank of answers that share its letters, and the answers' first letters spell whoever wrote it.", color: '#8c2f39', colorNavy: '#e8969f' },
