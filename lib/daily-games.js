...
const RAW = [
  ...
  { key: 'pricer', miss: null, name: 'Pricer', cat: 'Numbers', tag: 'Higher price wins', how: 'Sixteen real things from one category. One question: which costs more? Bracket them all before a single price is revealed.', color: '#15803d', colorNavy: '#4ade80' },
  ...
  { key: 'mate', keepsAnswer: true, miss: 'Errors', name: 'Mate', cat: 'End Game', tag: 'White to play and mate', how: 'Find the one move that forces checkmate, then play the line out against the best defence.', color: '#6b4423', colorNavy: '#d9b38c' },
  { key: 'four', keepsAnswer: true, miss: 'Errors', name: 'Four', cat: 'End Game', tag: 'One column wins', how: 'The position is already won for you. Find the single column that keeps it, because a wrong drop is not taken back.', color: '#1e3a8a', colorNavy: '#9db8ff' },
  ...
  { key: 'check', keepsAnswer: true, miss: 'Errors', name: 'Check', cat: 'End Game', tag: 'Red to play and sweep', how: 'Find the one move that takes every black piece inside three, then play it out with no take-back.', color: '#166e5a', colorNavy: '#5fd6b8' },
  ...
  { key: 'babel', keepsAnswer: true, miss: 'Stuck', name: 'Babel', cat: 'End Game', tag: 'The bag is empty', how: 'Nothing left to draw, so their rack is knowable. Play the last tiles for the best spread you can force.', color: '#14532d', colorNavy: '#6ee7b7' },
  ...
  { key: 'chain', keepsAnswer: true, miss: 'Errors', name: 'Chain', cat: 'End Game', tag: 'Take them, or leave them', how: 'The safe edges are gone and the boxes are counted in your favour. One edge keeps it, and the free box is usually the trap.', color: '#4a044e', colorNavy: '#f0abfc' },
  ...
  { key: 'turn', keepsAnswer: true, miss: 'Errors', name: 'Turn', cat: 'End Game', tag: 'Ten squares left', how: 'An Othello endgame you are already winning. One square keeps it, and flipping the fewest discs is the habit that gets you beaten.', color: '#226218', colorNavy: '#8cda81' },
  ...
  { key: 'chomp', keepsAnswer: true, miss: 'Moves', name: 'Chomp', cat: 'Logic', tag: 'Eat them in order', how: 'A cast of mascots to eat in order, and every square you touch stays yours for the rest of the run. Nothing chases you and nothing is on a clock. The only thing in your way is where you have already been, and the board is tight enough that finishing takes most of it.', color: '#a8430f', colorNavy: '#f0a071' },
...
// all 56 clients: these ten can reach the end of a run without the player ever
// being shown the solution. The five End Game titles say so in their own code
