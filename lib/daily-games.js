...
const RAW = [
  ...
  { key: 'defend', keepsAnswer: true, miss: 'Errors', name: 'Defend', cat: 'End Game', tag: 'Black to play and survive', how: 'White is threatening mate. Five moves look like they answer it and exactly one does, and finding it only buys you the next one.', color: '#2f4f4f', colorNavy: '#8fbdbd' },
];
