...
const RAW = [
  ...
  { key: 'jester', miss: 'Placed', name: 'Jesters', href: '/jesters', cat: 'Logic', tag: 'Seat the court', how: 'Seat one jester per row, per column, and per colored court, with no two ever touching. Sundays seat two apiece.', color: '#7c3aed', colorNavy: '#a78bfa' },
  ...
  { key: 'four', keepsAnswer: true, miss: 'Tries', name: 'Four', cat: 'End Game', tag: 'One column wins', how: 'The position is already won for you. Find the single column that keeps it, because a wrong drop is not taken back.', color: '#1e3a8a', colorNavy: '#9db8ff' },
