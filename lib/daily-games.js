...
const RAW = [
  ...
  // override below.
  { key: 'park', name: 'Parker', href: '/parker', cat: 'Logic', tag: 'Get the red one out', how: 'Everybody has blocked you in, every block is stuck on one axis, and there is one gap in the wall.', color: '#7c5c2e', colorNavy: '#f0cf9a' },
  ...
  { key: 'rung', name: 'Rung', cat: 'Word', tag: 'One letter at a time', how: 'Climb from one five-letter word to another, changing a single letter a rung, in as few rungs as you can.', color: '#155e75', colorNavy: '#7fd4e8' },
  { key: 'taire', name: 'Taire', cat: 'Logic', tag: 'The daily solitaire', how: 'Twenty cards face up, two suits, and a perfect line that is the proven minimum, so nobody beats it.', color: '#1d6b4f', colorNavy: '#86efac' },
  { key: 'fib', name: 'Fib', cat: 'Logic', tag: 'One clue is lying', how: 'The open end of each sign points at the larger number, but one of them is lying. Solve the grid, then name the liar.', color: '#4c1d95', colorNavy: '#c4b5fd' },
  ...
  { key: 'streak', name: 'Streak', cat: 'Trivia', tag: 'Forty questions, one life', how: 'Forty trivia questions climb from gimme to brutal, and one wrong answer or an empty clock ends the run.', color: '#e11d48', colorNavy: '#fb7185' },
  { key: 'feud', name: 'Feud', cat: 'Crowd Psychology', tag: 'Match the crowd', how: "Five prompts, three answers each, and the answer key is whatever today's players say. It shifts all day.", color: '#9f1239', colorNavy: '#fda4af' },
];
