...
const RAW = [
  ...
  { key: 'taire', miss: 'Moves', name: 'Taire', cat: 'End Game', tag: 'The daily solitaire', how: 'Twenty cards face up, two suits, and a perfect line that is the proven minimum, so nobody beats it.', color: '#1d6b4f', colorNavy: '#86efac' },
  ...
  { key: 'scrab', miss: 'Stuck', name: 'Scrab', cat: 'End Game', tag: 'The bag is empty', how: 'Nothing left to draw, so their rack is knowable. Play the last tiles for the best spread you can force.', color: '#14532d', colorNavy: '#6ee7b7' },
