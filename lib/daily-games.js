...
const RAW = [
  ...
  { key: 'babel', keepsAnswer: true, solvesOnScore: true, miss: 'Stuck', name: 'Babel', cat: 'End Game', tag: 'The bag is empty', how: 'Nothing left to draw, so their rack is knowable. Play the last tiles for the best spread you can force.', color: '#14532d', colorNavy: '#6ee7b7' },
  ...
  { key: 'defend', keepsAnswer: true, miss: 'Errors', name: 'Defend', cat: 'End Game', tag: 'Black to play and survive', how: 'White is threatening mate and every legal move on the board loses but one. Find it, then hold the position against the best try.', color: '#2f4f4f', colorNavy: '#8fbdbd' },
];
