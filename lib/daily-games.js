...
const RAW = [
  ...
  { key: 'check', miss: 'Errors', name: 'Check', cat: 'End Game', tag: 'Red to play and sweep', how: 'Find the one move that takes every black piece inside three, then play it out with no take-back.', color: '#166e5a', colorNavy: '#5fd6b8' },
  ...
  { key: 'chomp', miss: 'Moves', name: 'Chomp', cat: 'Logic', tag: 'Eat them in order', how: 'A cast of mascots to eat in order, and every square you touch stays yours for the rest of the run. Nothing chases you and nothing is on a clock. The only thing in your way is where you have already been, and the board is tight enough that finishing takes most of it.', color: '#a8430f', colorNavy: '#f0a071' },
