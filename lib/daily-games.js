...
const RAW = [
  ...
  { key: 'stands', miss: 'Rejects', name: 'Stands', cat: 'Logic', tag: 'Rebuild the results', how: 'Everyone played everyone once, so rebuild the full results table from the few surviving facts.', color: '#2563eb', colorNavy: '#93c5fd' },
  ...
  { key: 'blocks', miss: 'Shapes', unit: 'rows', name: 'Blocks', cat: 'Arcade', tag: 'Same shapes, same order', how: 'Falling shapes and the same order for everybody. Play as many runs as you like and your best one takes the board. It never speeds up, so a run ends on a hole you left three shapes ago.', color: '#2563eb', colorNavy: '#93b4f0' },
  ...
  { key: 'sixes', miss: null, name: 'Sixes', cat: 'Numbers', tag: 'The daily mini sudoku', how: 'A 6x6 sudoku in six boxes two squares tall and three wide. Every row, column and box holds 1 to 6 exactly once. The short one: about two minutes, nothing counts against you, and the clock decides the day.', color: '#2563eb', colorNavy: '#7da2f5' },
