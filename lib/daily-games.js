...
const RAW = [
  ...
  { key: 'blocks', miss: null, name: 'Blocks', cat: 'Arcade', tag: 'Same shapes, same order', how: 'Falling shapes, one life a day, and the same order for everybody. It never speeds up, so a run ends on a hole you left three shapes ago.', color: '#1d4ed8', colorNavy: '#93b4f0' },
];
