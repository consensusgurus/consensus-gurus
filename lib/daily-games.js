...
const RAW = [
  ...
  { key: 'dating', miss: 'Checks', name: 'Dating', cat: 'History', tag: 'Put history in order', how: 'Arrange five historical moments oldest to newest, in three checks or fewer.', color: '#6d28d9', colorNavy: '#a483f0' },
  ...
  { key: 'circa', miss: 'Guesses', name: 'Circa', cat: 'History', tag: 'Guess the year', how: 'Guess the year the moment happened, and each miss narrows the range.', color: '#0e7490', colorNavy: '#38b6cf' },
  { key: 'extra', miss: 'Tears', name: 'Extra', cat: 'History', tag: 'Name the story', how: 'Name the redacted historic headline, and every wrong guess tears another word free.', color: '#b91c1c', colorNavy: '#e06a6a' },
  ...
  { key: 'jester', miss: 'Placed', name: 'Jesters', cat: 'Logic', tag: 'Seat the court', how: 'Seat one jester per row, per column, and per colored court, with no two ever touching.', color: '#7c3aed', colorNavy: '#a78bfa' },
  ...
  { key: 'bracket', miss: null, name: 'Bracket', cat: 'History', tag: 'Name every winner', how: 'Make fifteen picks through a sixteen team bracket, where an early miss sinks every later line.', color: '#c2410c', colorNavy: '#fb923c' },
  ...
  { key: 'hedge', miss: 'Errors', name: 'Hedge', cat: 'Numbers', tag: 'Draw one closed loop', how: 'Draw one closed loop so every number has exactly that many sides on it.', color: '#0891b2', colorNavy: '#67e8f9' },
  { key: 'listed', miss: 'Checks', name: 'Listed', cat: 'History', tag: 'Rank the list, top to bottom', how: 'Rank eight real things in order, where green locks a pick and amber means one place off.', color: '#86198f', colorNavy: '#e9b8f5' },
  { key: 'mate', miss: 'Errors', name: 'Mate', cat: 'Logic', tag: 'White to play and mate', how: 'Find the one move that forces checkmate, then play the line out against the best defence.', color: '#6b4423', colorNavy: '#d9b38c' },
  { key: 'four', miss: 'Errors', name: 'Four', cat: 'Logic', tag: 'One column wins', how: 'The position is already won for you. Find the single column that keeps it, because a wrong drop is not taken back.', color: '#1e3a8a', colorNavy: '#9db8ff' },
  ...
  { key: 'check', miss: 'Errors', name: 'Check', cat: 'Logic', tag: 'Give a piece, take them all', how: 'Captures are compulsory, so hand one over and every black piece falls inside three moves.', color: '#166e5a', colorNavy: '#5fd6b8' },
  ...
  { key: 'taire', miss: 'Moves', name: 'Taire', cat: 'Logic', tag: 'The daily solitaire', how: 'Twenty cards face up, two suits, and a perfect line that is the proven minimum, so nobody beats it.', color: '#1d6b4f', colorNavy: '#86efac' },
