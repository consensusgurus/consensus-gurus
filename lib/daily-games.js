...
const RAW = [
  ...
  { key: 'etch', name: 'Etch', cat: 'Logic', tag: 'A picture in the numbers', color: '#4d7c0f', colorNavy: '#a3e635' },
  { key: 'hedge', name: 'Hedge', cat: 'Numbers', tag: 'Draw one closed loop', color: '#0891b2', colorNavy: '#67e8f9' },
  { key: 'listed', name: 'Listed', cat: 'History', tag: 'Rank the list, top to bottom', color: '#86198f', colorNavy: '#e9b8f5' },
];
