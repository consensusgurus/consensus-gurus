...
const RAW = [
  ...
  { key: 'bid', name: 'Bid', cat: 'Crowd Psychology', tag: 'One purse, five lots', how: 'Split a fixed purse across five lots and take the ones where you outbid the rest of the field.', color: '#7c2d12', colorNavy: '#d9a184' },
];
