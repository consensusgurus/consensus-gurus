...
const RAW = [
  ...
  // Renamed Park -> Unpark 2026-07-31. The KEY stays 'park' on purpose: it is the
  ...
  // override below.
  { key: 'park', name: 'Unpark', href: '/unpark', cat: 'Logic', tag: 'Get the red one out', how: 'Everybody has blocked you in, every block is stuck on one axis, and there is one gap in the wall.', color: '#7c5c2e', colorNavy: '#f0cf9a' },
...
// A row may override href when its route no longer matches its key (Unpark,
