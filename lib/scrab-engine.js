// Scrab — the shared endgame engine.
//
// ONE module, used in TWO places, which is the whole point: the authoring
// script (scripts/gen-scrab.mjs) computes each day's PAR with it, and the
// client (app/scrab/ScrabClient.jsx) plays the opponent's defence with it.
...
// against the defence they will actually face. scripts/verify-scrab.mjs
...
// local fight anyway), the bag is 64 tiles in near-Scrabble proportions with
...
// 64 tiles. No blanks (they would wreck both the deduction and the search) and
// no Q (a lone unplayable Q turns every endgame into the same puzzle).
export const BAG = {
  A: 5, B: 1, C: 2, D: 3, E: 7, F: 1, G: 2, H: 2, I: 5, J: 1, K: 1, L: 3, M: 2,
  N: 4, O: 5, P: 1, R: 4, S: 3, T: 4, U: 3, V: 1, W: 1, X: 1, Y: 1, Z: 1,
};
...
//
// Deterministic: same position, same number, every time. scripts/verify-scrab.mjs
