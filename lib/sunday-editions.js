...
//   chomp   the same seven mascots, spread much further apart, so more of the
//           board is already wall by the time the last one is in reach. Spread
//           is the knob because the cast is fixed at seven.
...
export const SUNDAY_EDITION_GAMES = [
  ...
  'babel', 'glyph', 'chain', 'turn', 'blocks', 'chomp', 'sweep',
];
