...
//   park    a par in the twenties instead of the high teens
...
//   taire   one free cell instead of two, which is a far bigger difference
//           than it sounds, and a par that runs half again as long
//
...
export const SUNDAY_EDITION_GAMES = [
  ...
  'listed', 'mate', 'four', 'park', 'check', 'rung', 'crunch', 'taire',
];
