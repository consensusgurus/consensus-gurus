...
export function sitemapEntries(baseUrl) {
  ...
  const staticPages = [
    ...
    { url: `${baseUrl}/cages`, lastModified: newestOfFormat('cages'), changeFrequency: 'daily', priority: 0.9 },
    { url: `${baseUrl}/sando`, lastModified: newestOfFormat('sando'), changeFrequency: 'daily', priority: 0.9 },
    ...
    // PRICER PULLED 2026-08-09 (see CLAUDE.md). Restore: grep -rn 'PRICER PULLED' sitemap entry, so it stops being indexed
    ...
    { url: `${baseUrl}/plot`, lastModified: newestOfFormat('plot'), changeFrequency: 'daily', priority: 0.9 },
    ...
    { url: `${baseUrl}/defend`, lastModified: newestOfFormat('defend'), changeFrequency: 'daily', priority: 0.9 },
    { url: `${baseUrl}/blitz`, lastModified: newestOfFormat('blitz'), changeFrequency: 'daily', priority: 0.9 },
