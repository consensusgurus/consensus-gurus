...
const GAME_PATHS = [
  ...
  'bracket', 'lode', 'etch', 'glyph', 'hedge', 'listed', 'mate', 'four', 'parker', 'check',
...
export function pagesEntries(baseUrl) {
  ...
  return [
    ...
    { url: `${baseUrl}/collegefootballrankings`, lastModified: rankingsDate, changeFrequency: 'weekly', priority: 0.8 },
    { url: `${baseUrl}/nflrankings`, lastModified: rankingsDate, changeFrequency: 'weekly', priority: 0.8 },
