...
function buildCard(count) {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: '#f7f8fa', fontFamily: 'Manrope', position: 'relative' } }, [
    ...
    T('Mind Loft', { fontSize: 104, fontWeight: 800, letterSpacing: '-3px', color: '#12141a', marginTop: '-34px' }),
    h('div', { key: 'div', style: { display: 'flex', width: '460px', height: '6px', borderRadius: '3px', background: '#fbb615', margin: '14px 0 22px' } }),
    T('ELEVATE YOUR THINKING', { fontSize: 42, fontWeight: 700, letterSpacing: '9px', color: '#0e1d40' }),
    T('DAILY PUZZLES AND QUIZZES TO SHARPEN YOUR BRAIN', { fontSize: 22, fontWeight: 700, letterSpacing: '2px', color: '#ffffff', background: '#0e1d40', borderRadius: '999px', padding: '15px 38px 15px 41px', marginTop: '30px' }),
    T('MINDLOFTDAILY.COM', { fontSize: 25, fontWeight: 800, letterSpacing: '4.5px', color: '#1e3a6b', marginTop: '22px' }),
  ]);
}
...
function buildListsCard(count) {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: '#f7f8fa', fontFamily: 'Manrope', position: 'relative' } }, [
    ...
    h('div', { key: 'div', style: { display: 'flex', width: '460px', height: '6px', borderRadius: '3px', background: '#fbb615', margin: '14px 0 22px' } }),
    T('WHERE EXPERTS AND AGGREGATORS AGREE', { fontSize: 42, fontWeight: 700, letterSpacing: '9px', color: '#0e1d40' }),
    T('TOP 10 LISTS · EXPERT AND READER CONSENSUS', { fontSize: 26, fontWeight: 700, letterSpacing: '3px', color: '#ffffff', background: '#0e1d40', borderRadius: '999px', padding: '15px 38px 15px 41px', marginTop: '30px' }),
...
function buildDailyCard() {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: '#f7f8fa', fontFamily: 'Manrope', position: 'relative' } }, [
    ...
    T('Mind Loft', { fontSize: 58, fontWeight: 800, letterSpacing: '-1.8px', color: '#1c1e24', marginTop: '-28px' }),
    h('div', { key: 'badge', style: { display: 'flex', alignItems: 'center', background: '#0e1d40', borderRadius: 16, padding: '12px 30px', marginTop: 22 } }, [
    ...
    T('CRUX · GARBLE · LINKS · SPAN · SUDS · AND MORE', { fontSize: 20, fontWeight: 700, letterSpacing: '2px', color: '#0e1d40', marginTop: 24 }),
...
function buildQuizCard({ title, blurb, category }) {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 72px', position: 'relative' } }, [
    ...
    h('div', { key: 'body', style: { display: 'flex', flexDirection: 'column' } }, [
      T(title || 'Mind Loft Quiz', { fontSize: 58, fontWeight: 800, letterSpacing: '-1.5px', color: '#1c1e24', lineHeight: 1.05, maxWidth: '96%' }),
    ...
    h('div', { key: 'ft', style: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderTop: '1px solid #e2e5ea', paddingTop: '18px' } }, [
      ...
      T('PLAY AT MINDLOFTDAILY.COM', { fontSize: 18, fontWeight: 700, letterSpacing: '2px', color: '#0e1d40' }),
    ]),
  ]);
}
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 72px', position: 'relative' } }, [
    ...
    h('div', { key: 'hd', style: { display: 'flex', flexDirection: 'column' } }, [
      h('div', { key: 'row', style: { display: 'flex', alignItems: 'center', justifyContent: 'space-between' } }, [
        h('div', { key: 'brand', style: { display: 'flex', alignItems: 'center' } }, [
          h('img', { key: 'i', src: iconRingsDataURI(), width: 116, height: 116, style: { marginLeft: '-16px', marginRight: '-2px' } }),
          T('Mind Loft', { fontSize: 40, fontWeight: 800, letterSpacing: '-1.2px', color: '#1c1e24' }),
        ]),
...
function buildQuizPromoCard({ title, blurb, category, id }) {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '52px 72px', position: 'relative' } }, [
    ...
    h('div', { key: 'body', style: { display: 'flex', flexDirection: 'column' } }, [
      T(clampStr(title || 'Mind Loft Quiz', 70), { fontSize: 56, fontWeight: 800, letterSpacing: '-1.5px', color: '#1c1e24', lineHeight: 1.04, maxWidth: '96%' }),
      ...
      T('Play the quiz. Elevate your thinking.', { fontSize: 24, fontWeight: 800, color: '#0e1d40', marginTop: '20px' }),
    ]),
    h('div', { key: 'ft', style: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderTop: '1px solid #e2e5ea', paddingTop: '18px' } }, [
    ...
    h('div', { key: 'hd', style: { display: 'flex', flexDirection: 'column' } }, [
      h('div', { key: 'row', style: { display: 'flex', alignItems: 'center', justifyContent: 'space-between' } }, [
        h('div', { key: 'brand', style: { display: 'flex', alignItems: 'center' } }, [
          ...
          T('Mind Loft', { fontSize: 38, fontWeight: 800, letterSpacing: '-1.2px', color: '#1c1e24' }),
        ]),
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    ...
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '560px' } }, [
      h('div', { key: 'brand', style: { display: 'flex', alignItems: 'center', marginBottom: 22 } }, [
        ...
        T('Mind Loft', { fontSize: 28, fontWeight: 800, letterSpacing: '-1px', color: '#1c1e24' }),
      ]),
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/CRUX', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 28 }),
    ]),
...
function buildGarbleCard() {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    ...
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '600px' } }, [
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/GARBLE', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 30 }),
    ]),
...
function buildLinksCard() {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    ...
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '560px' } }, [
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/LINKS', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 30 }),
    ]),
...
function buildSpanCard() {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    ...
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '640px' } }, [
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/SPAN', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 30 }),
    ]),
...
function buildDatingCard() {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    ...
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '580px' } }, [
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/DATING', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 30 }),
    ]),
...
function buildTallyCard() {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    ...
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '600px' } }, [
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/TALLY', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 30 }),
    ]),
...
function buildSudsCard() {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    ...
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '560px' } }, [
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/SUDS', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 30 }),
    ]),
...
function buildCircaCard() {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    ...
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '560px' } }, [
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/CIRCA', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 30 }),
    ]),
...
function buildExtraCard() {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    ...
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '560px' } }, [
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/EXTRA', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 30 }),
    ]),
...
function buildCarveCard() {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    ...
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '560px' } }, [
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/CARVE', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 30 }),
    ]),
...
function buildEmceeCard() {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    ...
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '560px' } }, [
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/EMCEE', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 30 }),
    ]),
...
function buildStetCard() {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    ...
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '560px' } }, [
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/STET', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 30 }),
    ]),
...
function buildOutwitCard() {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    ...
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '560px' } }, [
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/OUTWIT', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 30 }),
    ]),
...
function outrankBoardEl() {
  ...
  return h('div', { style: { display: 'flex', flexDirection: 'column', alignItems: 'flex-start', background: '#fff', border: '2px solid #1c1e24', borderRadius: 14, padding: '22px 24px 16px', width: '430px' } }, [
    ...
    h('div', { key: 'th', style: { display: 'flex', fontSize: 24, fontWeight: 800, color: '#1c1e24', marginBottom: 16 } }, 'The seasons of the year'),
    ...rows.map(([nr, name, w, gold], i) =>
      h('div', { key: 'r' + i, style: { display: 'flex', flexDirection: 'row', alignItems: 'center', width: '100%', marginBottom: 10 } }, [
        ...
        h('div', { key: 'l', style: { display: 'flex', fontSize: 20, fontWeight: 800, color: '#1c1e24', width: '120px' } }, name),
...
function buildOutrankCard() {
  const T = (txt, style) => h('div', { style: { display: 'flex', ...style } }, txt);
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    h('div', { key: 'bar', style: { position: 'absolute', top: 0, left: 0, width: '1200px', height: '9px', display: 'flex', background: 'linear-gradient(90deg,#0a1730,#4338ca 55%,#e8b43a)' } }),
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '560px' } }, [
      h('div', { key: 'brand', style: { display: 'flex', alignItems: 'center', marginBottom: 22 } }, [
        h('img', { key: 'i', src: iconRingsDataURI(), width: 72, height: 72, style: { marginLeft: '-10px', marginRight: '2px' } }),
      T('Mind Loft', { fontSize: 28, fontWeight: 800, letterSpacing: '-1px', color: '#1c1e24' }),
      ...
      h('div', { key: 'ttl', style: { display: 'flex', alignItems: 'center' } }, [
        T('Outrank', { fontSize: 88, fontWeight: 800, letterSpacing: '-3px', color: '#1c1e24', lineHeight: 1 }),
      ...
      T('PLAY FREE \u00b7 MINDLOFTDAILY.COM/OUTRANK', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 30 }),
    ]),
...
function buildTuckCard() {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    ...
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '560px' } }, [
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/TUCK', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 30 }),
    ]),
...
function buildAlibiCard() {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    ...
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '560px' } }, [
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/ALIBI', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 30 }),
    ]),
...
function buildCipherCard() {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    ...
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '560px' } }, [
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/CIPHER', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 30 }),
    ]),
...
function buildPingCard() {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    ...
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '560px' } }, [
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/PING', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 30 }),
    ]),
...
function buildWarmerCard() {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    ...
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '560px' } }, [
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/WARMER', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 30 }),
    ]),
...
function jesterBoardEl() {
  ...
  const rows = JESTER_DEMO_REGIONS.map((row, r) =>
    h('div', { key: `r${r}`, style: { display: 'flex', flexDirection: 'row' } },
      row.map((id, c) => {
        const bTop = r > 0 && JESTER_DEMO_REGIONS[r - 1][c] !== id ? '2.5px solid #1c1e24' : r > 0 ? '1px solid rgba(28,30,36,0.2)' : '0px solid transparent';
        const bLeft = c > 0 && JESTER_DEMO_REGIONS[r][c - 1] !== id ? '2.5px solid #1c1e24' : c > 0 ? '1px solid rgba(28,30,36,0.2)' : '0px solid transparent';
  ...
  return h('div', { style: { display: 'flex', flexDirection: 'column', alignItems: 'flex-start', background: '#fff', border: '2px solid #1c1e24', borderRadius: 14, padding: '20px 24px 18px' } }, [
    h('div', { key: 'mh', style: { display: 'flex', flexDirection: 'row', alignItems: 'center', width: '100%', borderBottom: '3px solid #1c1e24', paddingBottom: 8, marginBottom: 14 } }, [
      h('div', { key: 't', style: { display: 'flex', fontSize: 22, fontWeight: 800, color: '#1c1e24', letterSpacing: '0.5px' } }, 'One per row, column & court'),
    ...
    h('div', { key: 'bd', style: { display: 'flex', flexDirection: 'column', border: '3px solid #1c1e24', borderRadius: 8, overflow: 'hidden' } }, rows),
...
function buildJesterCard() {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    ...
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '560px' } }, [
      ...
      h('div', { key: 'ttl', style: { display: 'flex', alignItems: 'center' } }, [
        T('Jesters', { fontSize: 96, fontWeight: 800, letterSpacing: '-3px', color: '#1c1e24', lineHeight: 1 }),
        T('DAILY', { fontSize: 20, fontWeight: 800, letterSpacing: '2px', color: '#fff', background: '#7c3aed', borderRadius: 8, padding: '6px 12px', marginLeft: 20 }),
      ]),
      h('div', { key: 'div', style: { display: 'flex', width: '210px', height: '4px', background: '#7c3aed', margin: '16px 0 18px' } }),
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/JESTER', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 30 }),
    ]),
...
function swornBoardEl() {
  ...
  const row = (name, stmt, lying, key) => h('div', { key, style: { display: 'flex', alignItems: 'center', width: W, borderRadius: 10, padding: '11px 14px', marginBottom: 9, background: '#fff', border: '1.5px solid rgba(28,30,36,0.16)', borderLeft: '4px solid #be185d' } }, [
    ...
    h('div', { key: 'tx', style: { display: 'flex', flexDirection: 'column' } }, [
      ...
      h('div', { key: 's', style: { display: 'flex', fontSize: 18, fontWeight: 700, color: '#1c1e24' } }, stmt),
    ]),
  ]);
  return h('div', { style: { display: 'flex', flexDirection: 'column', alignItems: 'flex-start', background: '#f4f2f5', border: '2px solid #1c1e24', borderRadius: 14, padding: '20px 22px 12px' } }, [
    h('div', { key: 'mh', style: { display: 'flex', flexDirection: 'row', alignItems: 'center', width: '100%', borderBottom: '3px solid #1c1e24', paddingBottom: 8, marginBottom: 12 } }, [
      h('div', { key: 't', style: { display: 'flex', fontSize: 22, fontWeight: 800, color: '#1c1e24', letterSpacing: '0.5px' } }, 'Exactly 2 are lying'),
...
function buildSwornCard() {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    ...
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '560px' } }, [
      ...
      h('div', { key: 'ttl', style: { display: 'flex', alignItems: 'center' } }, [
        T('Sworn', { fontSize: 96, fontWeight: 800, letterSpacing: '-3px', color: '#1c1e24', lineHeight: 1 }),
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/SWORN', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 30 }),
    ]),
...
function axiomTileEl(word, state, key) {
  ...
  const ink = state === 'yes' ? '#14532d' : state === 'no' ? '#7f1d1d' : '#1c1e24';
...
function axiomBoardEl() {
  ...
  return h('div', { style: { display: 'flex', flexDirection: 'column', alignItems: 'center', background: '#f4f2f5', border: '2px solid #1c1e24', borderRadius: 14, padding: '20px 18px 12px' } }, [
    h('div', { key: 'mh', style: { display: 'flex', flexDirection: 'row', alignItems: 'center', width: '100%', borderBottom: '3px solid #1c1e24', paddingBottom: 8, marginBottom: 10 } }, [
      h('div', { key: 't', style: { display: 'flex', fontSize: 21, fontWeight: 800, color: '#1c1e24', letterSpacing: '0.5px' } }, 'One rule fits them all'),
...
function buildAxiomCard() {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    ...
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '560px' } }, [
      ...
      h('div', { key: 'ttl', style: { display: 'flex', alignItems: 'center' } }, [
        T('Axiom', { fontSize: 96, fontWeight: 800, letterSpacing: '-3px', color: '#1c1e24', lineHeight: 1 }),
        T('DAILY', { fontSize: 20, fontWeight: 800, letterSpacing: '2px', color: '#fff', background: '#0f766e', borderRadius: 8, padding: '6px 12px', marginLeft: 20 }),
      ]),
      h('div', { key: 'div', style: { display: 'flex', width: '210px', height: '4px', background: '#0f766e', margin: '16px 0 18px' } }),
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/AXIOM', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 30 }),
    ]),
...
function hearsayRowEl(label, chips, key) {
  return h('div', { key, style: { display: 'flex', alignItems: 'center', width: 430, borderRadius: 10, padding: '9px 12px', marginBottom: 8, background: '#fff', border: '1.5px solid rgba(28,30,36,0.16)', borderLeft: '4px solid #7c2d92' } }, [
    ...
    h('div', { key: 'c', style: { display: 'flex', flexDirection: 'row' } }, chips.map((c, i) => h('div', { key: 'c' + i, style: { display: 'flex', alignItems: 'center', justifyContent: 'center', height: 32, borderRadius: 7, padding: '0 11px', marginRight: 6, background: '#f7f8fa', border: '1.5px solid rgba(28,30,36,0.2)', fontSize: 16, fontWeight: 800, color: '#1c1e24' } }, c))),
  ]);
}
function hearsayBoardEl() {
  return h('div', { style: { display: 'flex', flexDirection: 'column', alignItems: 'flex-start', background: '#f4f2f5', border: '2px solid #1c1e24', borderRadius: 14, padding: '20px 22px 14px' } }, [
    h('div', { key: 'mh', style: { display: 'flex', flexDirection: 'row', alignItems: 'center', width: '100%', borderBottom: '3px solid #1c1e24', paddingBottom: 8, marginBottom: 12 } }, [
      h('div', { key: 't', style: { display: 'flex', fontSize: 21, fontWeight: 800, color: '#1c1e24', letterSpacing: '0.5px' } }, 'One of these is the one'),
    ...
    h('div', { key: 's1', style: { display: 'flex', fontSize: 17, fontWeight: 700, color: '#1c1e24', marginTop: 4 } }, 'Marisol: “I don’t know which sailing it is.”'),
    h('div', { key: 's2', style: { display: 'flex', fontSize: 17, fontWeight: 700, color: '#1c1e24', marginTop: 4 } }, 'Ivo: “Then neither do I.”'),
...
function buildHearsayCard() {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    ...
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '560px' } }, [
      ...
      h('div', { key: 'ttl', style: { display: 'flex', alignItems: 'center' } }, [
        T('Hearsay', { fontSize: 88, fontWeight: 800, letterSpacing: '-3px', color: '#1c1e24', lineHeight: 1 }),
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/HEARSAY', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 30 }),
    ]),
...
function vennBoardEl() {
  const chip = (t, key) => h('div', { key, style: { display: 'flex', alignItems: 'center', justifyContent: 'center', height: 30, borderRadius: 7, padding: '0 10px', margin: 3, background: '#fff', border: '1.5px solid rgba(28,30,36,0.2)', fontSize: 15, fontWeight: 800, color: '#1c1e24' } }, t);
  ...
  return h('div', { style: { display: 'flex', flexDirection: 'column', alignItems: 'center', background: '#f4f2f5', border: '2px solid #1c1e24', borderRadius: 14, padding: '18px 20px 14px', width: 420 } }, [
    h('div', { key: 'mh', style: { display: 'flex', flexDirection: 'row', alignItems: 'center', width: '100%', borderBottom: '3px solid #1c1e24', paddingBottom: 8, marginBottom: 10 } }, [
      h('div', { key: 't', style: { display: 'flex', fontSize: 20, fontWeight: 800, color: '#1c1e24' } }, 'Seven regions, every one used'),
...
function buildVennCard() {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 56px', position: 'relative' } }, [
    ...
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '560px' } }, [
      ...
      h('div', { key: 'ttl', style: { display: 'flex', alignItems: 'center' } }, [
        T('Venn', { fontSize: 96, fontWeight: 800, letterSpacing: '-3px', color: '#1c1e24', lineHeight: 1 }),
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/VENN', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 28 }),
    ]),
...
function standsBoardEl() {
  ...
  return h('div', { style: { display: 'flex', flexDirection: 'column', alignItems: 'flex-start', background: '#f4f2f5', border: '2px solid #1c1e24', borderRadius: 14, padding: '18px 20px 12px' } }, [
    h('div', { key: 'mh', style: { display: 'flex', flexDirection: 'row', alignItems: 'center', width: '100%', borderBottom: '3px solid #1c1e24', paddingBottom: 8, marginBottom: 10 } }, [
      h('div', { key: 't', style: { display: 'flex', fontSize: 20, fontWeight: 800, color: '#1c1e24' } }, 'One table fits the facts'),
...
function buildStandsCard() {
  const T = (txt, style) => h('div', { style: { display: 'flex', ...style } }, txt);
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    h('div', { key: 'bar', style: { position: 'absolute', top: 0, left: 0, width: '1200px', height: '9px', display: 'flex', background: 'linear-gradient(90deg,#0a1730,#1e3a6b 55%,#1d4ed8)' } }),
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '560px' } }, [
      h('div', { key: 'brand', style: { display: 'flex', alignItems: 'center', marginBottom: 20 } }, [
        h('img', { key: 'i', src: iconRingsDataURI(), width: 72, height: 72, style: { marginLeft: '-10px', marginRight: '2px' } }),
        T('Mind Loft', { fontSize: 28, fontWeight: 800, letterSpacing: '-1px', color: '#1c1e24' }),
      ...
      h('div', { key: 'ttl', style: { display: 'flex', alignItems: 'center' } }, [
        T('Stands', { fontSize: 88, fontWeight: 800, letterSpacing: '-3px', color: '#1c1e24', lineHeight: 1 }),
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/STANDS', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 28 }),
    ]),
...
function bracketSlotEl(t, state, key) {
  ...
  const ink = state === 'win' ? '#9a3412' : '#1c1e24';
...
function bracketBoardEl() {
  ...
  return h('div', { style: { display: 'flex', flexDirection: 'column', alignItems: 'flex-start', background: '#f4f2f5', border: '2px solid #1c1e24', borderRadius: 14, padding: '18px 20px 14px' } }, [
    h('div', { key: 'mh', style: { display: 'flex', flexDirection: 'row', alignItems: 'center', width: '100%', borderBottom: '3px solid #1c1e24', paddingBottom: 8, marginBottom: 10 } }, [
      h('div', { key: 't', style: { display: 'flex', fontSize: 19, fontWeight: 800, color: '#1c1e24' } }, 'Which came first?'),
...
function buildBracketCard() {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 56px', position: 'relative' } }, [
    ...
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '540px' } }, [
      ...
      h('div', { key: 'ttl', style: { display: 'flex', alignItems: 'center' } }, [
        T('Bracket', { fontSize: 88, fontWeight: 800, letterSpacing: '-3px', color: '#1c1e24', lineHeight: 1 }),
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/BRACKET', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 28 }),
    ]),
...
function lodeBoardEl() {
  ...
  const cell = (ch, core) => h('div', {
    ...
    style: {
      ...
      fontSize: 31, fontWeight: 800, color: core ? '#fff' : '#1c1e24',
    },
  }, ch);
  return h('div', { style: { display: 'flex', flexDirection: 'column', alignItems: 'center', background: '#fef7e0', border: '2px solid #1c1e24', borderRadius: 14, padding: '20px 26px 16px' } }, [
    h('div', { key: 'mh', style: { display: 'flex', flexDirection: 'row', alignItems: 'center', width: '100%', borderBottom: '3px solid #1c1e24', paddingBottom: 8, marginBottom: 16 } }, [
      h('div', { key: 't', style: { display: 'flex', fontSize: 22, fontWeight: 800, color: '#1c1e24', letterSpacing: '0.5px' } }, 'Every word uses the core'),
...
function buildLodeCard() {
  const T = (txt, style) => h('div', { style: { display: 'flex', ...style } }, txt);
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    h('div', { key: 'bar', style: { position: 'absolute', top: 0, left: 0, width: '1200px', height: '9px', display: 'flex', background: 'linear-gradient(90deg,#0a1730,#1e3a6b 55%,#a16207)' } }),
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '560px' } }, [
      h('div', { key: 'brand', style: { display: 'flex', alignItems: 'center', marginBottom: 22 } }, [
        h('img', { key: 'i', src: iconRingsDataURI(), width: 72, height: 72, style: { marginLeft: '-10px', marginRight: '2px' } }),
        T('Mind Loft', { fontSize: 28, fontWeight: 800, letterSpacing: '-1px', color: '#1c1e24' }),
      ...
      h('div', { key: 'ttl', style: { display: 'flex', alignItems: 'center' } }, [
        T('Lode', { fontSize: 100, fontWeight: 800, letterSpacing: '-3px', color: '#1c1e24', lineHeight: 1 }),
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/LODE', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 30 }),
    ]),
  ...
  const rowEl = (r) => {
    ...
    return h('div', { key: `r${r}`, style: { display: 'flex', flexDirection: 'row' } }, [
      ...
      ...Array.from({ length: 8 }, (_, c) => h('div', { key: `${r},${c}`, style: {
        ...
        background: art[r][c] === '#' ? '#1c1e24' : '#fff',
        border: '1px solid rgba(28,30,36,0.22)',
      } })),
    ]);
  };
  return h('div', { style: { display: 'flex', flexDirection: 'column', alignItems: 'flex-start', background: '#fff', border: '2px solid #1c1e24', borderRadius: 14, padding: '20px 20px 18px' } }, [
...
function buildEtchCard() {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    ...
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '560px' } }, [
      ...
      h('div', { key: 'ttl', style: { display: 'flex', alignItems: 'center' } }, [
        T('Etch', { fontSize: 100, fontWeight: 800, letterSpacing: '-3px', color: '#1c1e24', lineHeight: 1 }),
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/ETCH', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 30 }),
    ]),
...
function hedgeBoardEl() {
  ...
  clues.forEach((row, i) => row.forEach((c, j) => {
    ...
    kids.push(h('div', { key: `c${i}-${j}`, style: {
      ...
      display: 'flex', alignItems: 'center', justifyContent: 'center',
      fontSize: 19, fontWeight: 600, color: '#1c1e24',
    } }, String(c)));
  }));
...
function buildHedgeCard() {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    ...
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '560px' } }, [
      ...
      h('div', { key: 'ttl', style: { display: 'flex', alignItems: 'center' } }, [
        T('Hedge', { fontSize: 100, fontWeight: 800, letterSpacing: '-3px', color: '#1c1e24', lineHeight: 1 }),
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/HEDGE', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 30 }),
    ]),
...
function buildListedCard() {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    ...
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '560px' } }, [
      ...
      h('div', { key: 'ttl', style: { display: 'flex', alignItems: 'center' } }, [
        T('Listed', { fontSize: 100, fontWeight: 800, letterSpacing: '-3px', color: '#1c1e24', lineHeight: 1 }),
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/LISTED', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 30 }),
    ]),
...
function mateBoardDataURI() {
  ...
  parts.push(`<rect x="0" y="0" width="${BOX}" height="${BOX}" rx="8" fill="#1c1e24"/>`);
  ...
  for (let r = 0; r < 8; r++) {
    ...
    for (const ch of rows[r]) {
      ...
      parts.push(
        ...
        `<path d="${MATE_PIECE_PATH[ch.toUpperCase()]}" fill="${white ? '#ffffff' : '#16181d'}" ` +
        `stroke="${white ? '#16181d' : '#ffffff'}" stroke-width="${white ? 2 : 1.1}" stroke-linejoin="round"/></g>`
      );
      f++;
    }
  }
...
function buildMateCard() {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    ...
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '560px' } }, [
      ...
      h('div', { key: 'ttl', style: { display: 'flex', alignItems: 'center' } }, [
        T('Mate', { fontSize: 100, fontWeight: 800, letterSpacing: '-3px', color: '#1c1e24', lineHeight: 1 }),
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/MATE', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 30 }),
    ]),
...
function buildFourCard() {
  const T = (txt, style) => h('div', { style: { display: 'flex', ...style } }, txt);
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    h('div', { key: 'bar', style: { position: 'absolute', top: 0, left: 0, width: '1200px', height: '9px', display: 'flex', background: 'linear-gradient(90deg,#0a1730,#1e3a8a 55%,#d62828)' } }),
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '545px' } }, [
      ...
      h('div', { key: 'ttl', style: { display: 'flex', alignItems: 'center' } }, [
        T('Four', { fontSize: 100, fontWeight: 800, letterSpacing: '-3px', color: '#1c1e24', lineHeight: 1 }),
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/FOUR', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 30 }),
    ]),
...
function buildParkerCard() {
  const T = (txt, style) => h('div', { style: { display: 'flex', ...style } }, txt);
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    h('div', { key: 'bar', style: { position: 'absolute', top: 0, left: 0, width: '1200px', height: '9px', display: 'flex', background: 'linear-gradient(90deg,#0a1730,#7c5c2e 55%,#c0392b)' } }),
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '545px' } }, [
      h('div', { key: 'brand', style: { display: 'flex', alignItems: 'center', marginBottom: 22 } }, [
        h('img', { key: 'i', src: iconRingsDataURI(), width: 72, height: 72, style: { marginLeft: '-10px', marginRight: '2px' } }),
        T('Mind Loft', { fontSize: 28, fontWeight: 800, letterSpacing: '-1px', color: '#1c1e24' }),
      ...
      h('div', { key: 'ttl', style: { display: 'flex', alignItems: 'center' } }, [
        T('Parker', { fontSize: 92, fontWeight: 800, letterSpacing: '-3px', color: '#1c1e24', lineHeight: 1 }),
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/PARKER', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 30 }),
    ]),
...
function checkBoardDataURI() {
  ...
  p.push(`<rect x="0" y="0" width="${W}" height="${W}" rx="10" fill="#1c1e24"/>`);
  for (let r = 0; r < 8; r++) for (let c = 0; c < 8; c++) {
    const dark = ((r + c) & 1) === 1;
...
function buildCheckCard() {
  const T = (txt, style) => h('div', { style: { display: 'flex', ...style } }, txt);
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    h('div', { key: 'bar', style: { position: 'absolute', top: 0, left: 0, width: '1200px', height: '9px', display: 'flex', background: 'linear-gradient(90deg,#0a1730,#166e5a 55%,#c0392b)' } }),
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '545px' } }, [
      h('div', { key: 'brand', style: { display: 'flex', alignItems: 'center', marginBottom: 22 } }, [
        h('img', { key: 'i', src: iconRingsDataURI(), width: 72, height: 72, style: { marginLeft: '-10px', marginRight: '2px' } }),
        T('Mind Loft', { fontSize: 28, fontWeight: 800, letterSpacing: '-1px', color: '#1c1e24' }),
      ...
      h('div', { key: 'ttl', style: { display: 'flex', alignItems: 'center' } }, [
        T('Check', { fontSize: 100, fontWeight: 800, letterSpacing: '-3px', color: '#1c1e24', lineHeight: 1 }),
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/CHECK', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 30 }),
    ]),
...
function rungBoardEl() {
  const T = (txt, style) => h('div', { style: { display: 'flex', ...style } }, txt);
  return h('div', { style: { display: 'flex', flexDirection: 'column', alignItems: 'flex-start', background: '#fff', border: '2px solid #1c1e24', borderRadius: 14, padding: '22px 26px 20px' } }, [
...
function buildRungCard() {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    ...
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '560px' } }, [
      ...
      h('div', { key: 'ttl', style: { display: 'flex', alignItems: 'center' } }, [
        T('Rung', { fontSize: 100, fontWeight: 800, letterSpacing: '-3px', color: '#1c1e24', lineHeight: 1 }),
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/RUNG', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 30 }),
    ]),
...
function crunchBoardEl() {
  ...
  const tile = (n, i) => h('div', {
    ...
    style: {
      ...
      borderRadius: '10px', background: '#f3f1ea', border: '2px solid #1c1e24',
      fontSize: 36, fontWeight: 800, color: '#1c1e24',
    },
  }, String(n));
  return h('div', { style: { display: 'flex', flexDirection: 'column', alignItems: 'center', background: '#fff', border: '2px solid #1c1e24', borderRadius: 14, padding: '22px 22px 12px' } }, [
...
function buildCrunchCard() {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    ...
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '560px' } }, [
      ...
      h('div', { key: 'ttl', style: { display: 'flex', alignItems: 'center' } }, [
        T('Crunch', { fontSize: 100, fontWeight: 800, letterSpacing: '-3px', color: '#1c1e24', lineHeight: 1 }),
        T('DAILY', { fontSize: 20, fontWeight: 800, letterSpacing: '2px', color: '#fff', background: '#b45309', borderRadius: 8, padding: '6px 12px', marginLeft: 20 }),
      ]),
      h('div', { key: 'div', style: { display: 'flex', width: '210px', height: '4px', background: '#b45309', margin: '16px 0 18px' } }),
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/CRUNCH', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 30 }),
    ]),
...
function buildTaireCard() {
  const T = (txt, style) => h('div', { style: { display: 'flex', ...style } }, txt);
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    h('div', { key: 'bar', style: { position: 'absolute', top: 0, left: 0, width: '1200px', height: '9px', display: 'flex', background: 'linear-gradient(90deg,#0a1730,#1d6b4f 55%,#c0392b)' } }),
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '545px' } }, [
      h('div', { key: 'brand', style: { display: 'flex', alignItems: 'center', marginBottom: 22 } }, [
        h('img', { key: 'i', src: iconRingsDataURI(), width: 72, height: 72, style: { marginLeft: '-10px', marginRight: '2px' } }),
        T('Mind Loft', { fontSize: 28, fontWeight: 800, letterSpacing: '-1px', color: '#1c1e24' }),
      ...
      h('div', { key: 'ttl', style: { display: 'flex', alignItems: 'center' } }, [
        T('Taire', { fontSize: 100, fontWeight: 800, letterSpacing: '-3px', color: '#1c1e24', lineHeight: 1 }),
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/TAIRE', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 30 }),
    ]),
...
const FIB_DEMO_V = [];
function fibBoardEl() {
  const CELL = 64, SIGN = 28, INK = '#1c1e24', ACC = '#4c1d95', AMBER = '#b45309';
...
function buildFibCard() {
  const T = (txt, style) => h('div', { style: { display: 'flex', ...style } }, txt);
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    h('div', { key: 'bar', style: { position: 'absolute', top: 0, left: 0, width: '1200px', height: '9px', display: 'flex', background: 'linear-gradient(90deg,#0a1730,#4c1d95 55%,#c0392b)' } }),
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '545px' } }, [
      h('div', { key: 'brand', style: { display: 'flex', alignItems: 'center', marginBottom: 22 } }, [
        h('img', { key: 'i', src: iconRingsDataURI(), width: 72, height: 72, style: { marginLeft: '-10px', marginRight: '2px' } }),
        T('Mind Loft', { fontSize: 28, fontWeight: 800, letterSpacing: '-1px', color: '#1c1e24' }),
      ...
      h('div', { key: 'ttl', style: { display: 'flex', alignItems: 'center' } }, [
        T('Fib', { fontSize: 100, fontWeight: 800, letterSpacing: '-3px', color: '#1c1e24', lineHeight: 1 }),
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/FIB', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 30 }),
    ]),
...
function streakBoardEl() {
  ...
  const row = (txt, i) => h('div', {
    ...
    T(txt, { fontSize: 19, fontWeight: 700, color: '#1c1e24' }),
  ]);
  return h('div', { style: { display: 'flex', flexDirection: 'column', background: '#fff', border: '2px solid #1c1e24', borderRadius: 14, padding: '20px 22px 12px' } }, [
    ...
    T(STREAK_DEMO.q, { fontSize: 21, fontWeight: 800, color: '#1c1e24', marginBottom: 14, maxWidth: 360, lineHeight: 1.3 }),
...
function buildStreakCard() {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    ...
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '560px' } }, [
      ...
      h('div', { key: 'ttl', style: { display: 'flex', alignItems: 'center' } }, [
        T('Streak', { fontSize: 100, fontWeight: 800, letterSpacing: '-3px', color: '#1c1e24', lineHeight: 1 }),
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/STREAK', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 30 }),
    ]),
...
function feudBoardEl() {
  ...
  const bars = rows.map((r, i) => h('div', { key: `r${i}`, style: { display: 'flex', flexDirection: 'row', alignItems: 'center', marginTop: i ? 10 : 0 } }, [
    h('div', { key: 'n', style: { display: 'flex', alignItems: 'center', justifyContent: 'center', width: '34px', height: '34px', borderRadius: 8, background: '#eceef1', fontSize: 17, fontWeight: 800, color: '#6b7280', marginRight: 10 } }, String(r.rank)),
    h('div', { key: 'b', style: { display: 'flex', flexDirection: 'column', width: '330px' } }, [
      h('div', { key: 't', style: { display: 'flex', flexDirection: 'row', justifyContent: 'space-between' } }, [
        h('div', { key: 'l', style: { display: 'flex', fontSize: 17, fontWeight: 800, color: '#1c1e24', letterSpacing: '0.5px' } }, r.label),
  ...
  return h('div', { style: { display: 'flex', flexDirection: 'column', alignItems: 'flex-start', background: '#fff', border: '2px solid #1c1e24', borderRadius: 14, padding: '20px 24px 20px' } }, [
    h('div', { key: 'mh', style: { display: 'flex', flexDirection: 'row', alignItems: 'center', width: '100%', borderBottom: '3px solid #1c1e24', paddingBottom: 8, marginBottom: 14 } }, [
      h('div', { key: 't', style: { display: 'flex', fontSize: 20, fontWeight: 800, color: '#1c1e24', letterSpacing: '0.5px' } }, 'Lost at the beach?'),
...
function buildFeudCard() {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    ...
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '560px' } }, [
      ...
      h('div', { key: 'ttl', style: { display: 'flex', alignItems: 'center' } }, [
        T('Feud', { fontSize: 100, fontWeight: 800, letterSpacing: '-3px', color: '#1c1e24', lineHeight: 1 }),
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/FEUD', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 30 }),
    ]),
...
function babelTileEl(ch, pts, key, opts = {}) {
  ...
  return h('div', {
    ...
    style: {
      ...
      fontSize: Math.round(size * 0.55), fontWeight: 800, color: '#1c1e24',
    },
  }, [
...
function babelBoardEl() {
  ...
  return h('div', {
    style: {
      ...
      background: '#0d3b20', border: '3px solid #1c1e24', borderRadius: 14, padding: '20px 20px 16px',
    },
  }, [
    row([
      cell('3W', '#e2725b', '#fff', 'a'),
      cell('Q', '#f7edda', '#1c1e24', 'b'),
      cell('U', '#f7edda', '#1c1e24', 'c'),
      cell('2L', '#b3d4ea', '#1f4e6b', 'd'),
      cell('', '#e9efe9', '#1c1e24', 'e'),
    ], 'r1'),
    row([
      cell('', '#e9efe9', '#1c1e24', 'f'),
      cell('', '#e9efe9', '#1c1e24', 'g'),
      cell('N', '#f7edda', '#1c1e24', 'h'),
    ...
    row([
      ...
      cell('T', '#f7edda', '#1c1e24', 'n'),
      cell('', '#e9efe9', '#1c1e24', 'o'),
    ], 'r3'),
...
function buildBabelCard() {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    ...
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '560px' } }, [
      ...
      h('div', { key: 'ttl', style: { display: 'flex', alignItems: 'center' } }, [
        T('Babel', { fontSize: 100, fontWeight: 800, letterSpacing: '-3px', color: '#1c1e24', lineHeight: 1 }),
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/BABEL', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 30 }),
    ]),
  ...
  NUM.forEach((row, i) => row.forEach((n, j) => {
    ...
    if (!n) {
      kids.push(h('div', { key: `b${i}-${j}`, style: {
        ...
        background: '#1c1e24', display: 'flex',
      } }));
      return;
    }
    const L = SOLVED[n];
...
function buildGlyphCard() {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', background: '#f7f8fa', fontFamily: 'Manrope', padding: '54px 60px', position: 'relative' } }, [
    ...
    h('div', { key: 'left', style: { display: 'flex', flexDirection: 'column', width: '560px' } }, [
      ...
      h('div', { key: 'ttl', style: { display: 'flex', alignItems: 'center' } }, [
        T('Glyph', { fontSize: 100, fontWeight: 800, letterSpacing: '-3px', color: '#1c1e24', lineHeight: 1 }),
      ...
      T('PLAY FREE · MINDLOFTDAILY.COM/GLYPH', { fontSize: 20, fontWeight: 800, letterSpacing: '1.5px', color: '#1c1e24', marginTop: 30 }),
    ]),
