...
function buildCard(count) {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: '#f7f8fa', fontFamily: 'Manrope', position: 'relative' } }, [
    ...
    T('DAILY GAMES · QUIZZES · TOP 10 LISTS · SOURCEOFTRUTHS.COM', { fontSize: 19, fontWeight: 700, letterSpacing: '2.5px', color: '#9aa0ab', marginTop: '24px' }),
  ]);
}
...
// Daily Games hub share card (app/daily). Distinct from the default brand card:
// centered layout, a navy DAILY GAMES badge as the hero, and a games-focused
...
function buildDailyCard() {
  ...
  return h('div', { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: '#f7f8fa', fontFamily: 'Manrope', position: 'relative' } }, [
    ...
    h('div', { key: 'badge', style: { display: 'flex', alignItems: 'center', background: '#0e1d40', borderRadius: 16, padding: '12px 30px', marginTop: 22 } }, [
      T('DAILY GAMES', { fontSize: 50, fontWeight: 800, letterSpacing: '4px', color: '#ffffff' }),
    ]),
    T('A new word, number, and logic game every day.', { fontSize: 30, fontWeight: 600, color: '#6b7280', marginTop: 26 }),
