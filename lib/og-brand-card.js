...
const FIB_DEMO_H = [[0, 0, '>', false], [2, 2, '<', true], [4, 1, '<', false], [1, 3, '>', false]];
// [row, col, glyph, lying] for the sign BELOW that cell
const FIB_DEMO_V = [[0, 3, '∨', false], [1, 0, '∧', false], [3, 4, '∨', false]];
function fibBoardEl() {
    ...
    for (let c = 0; c < 5; c++) {
      ...
      if (c < 4) {
        ...
        cells.push(h('div', {
          ...
          style: {
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            width: `${SIGN}px`, height: `${CELL}px`, fontSize: 26, fontWeight: 800,
