...
export const PUZZLE_CATEGORIES = [
  ...
  },
  {
    ...
    description: 'Seventeen free daily logic puzzles: a nonogram, slitherlink, shikaku, two sizes of sliding block puzzle, whodunit deduction grids, liar puzzles and more. Every board has exactly one solution reachable by logic. New puzzles at midnight Eastern, no signup.',
    lede: 'Seventeen logic puzzles with one new board apiece every day. Pencil-and-paper classics (a nonogram, a slitherlink loop, shikaku rectangles, a sliding block puzzle in two sizes) alongside deduction puzzles built around suspects, liars, hidden rules and results tables. Every board has exactly one solution and can be reached without a guess.',
