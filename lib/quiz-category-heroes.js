...
export const CATEGORY_HEROES = {
  ...
  movies:        { quizId: 'name-the-movie-from-poster',           hero: 'https://image.tmdb.org/t/p/w780/AmyQTQsNxITitCM0Ya5l5bpYGpn.jpg', pos: 'center 32%' }, // a featured movie poster (Pulp Fiction, textless) from the poster quiz
  ...
  entertainment: { quizId: 'match-the-succession-character',       hero: 'https://upload.wikimedia.org/wikipedia/commons/0/06/Brian_Cox_Edinburgh_2025.jpg', pos: 'center 20%' }, // Brian Cox (Logan Roy), Succession
...
export const HERO_CREDITS = {
  ...
  entertainment: 'https://commons.wikimedia.org/wiki/File:Brian_Cox_Edinburgh_2025.jpg',
