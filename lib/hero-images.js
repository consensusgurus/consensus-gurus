...
export const HERO_IMAGES = {
  ...
  'burgers-atlanta': {
    'NFA Burger (Dunwoody)': {
      src: 'https://cdn.vox-cdn.com/thumbor/rEmUedll2jn1rz3hmlgJPaiFGF0=/0x0:1067x800/1200x480/filters:focal(456x325:626x495)/cdn.vox-cdn.com/uploads/chorus_image/image/73530655/366639377_778151100980087_6296068063560568876_n.0.jpg',
      credit: 'Eater Atlanta',
      creditUrl: 'https://atlanta.eater.com',
    },
    "Fred's Meat & Bread (Inman Park)": {
      src: 'https://miro.medium.com/v2/resize:fit:1200/1*xF4xRXC3VG7qLM4YOSQl_g.jpeg',
      credit: 'The Burger Stack',
      creditUrl: 'https://medium.com',
    },
    "Smiley's Burger Club (Decatur)": {
      src: 'https://res.cloudinary.com/the-infatuation/image/upload/c_scale,w_1200,q_auto,f_auto/Atlanta_Smiley_s_AmySinclair-5_pukp17',
