...
export const HERO_IMAGES = {
  ...
  'greek-islands-not-mykonos-santorini': {
    "Crete (Greece's largest island)": {
      src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/33/BalosLagoonCreta.jpg/1920px-BalosLagoonCreta.jpg',
      credit: 'Wikimedia Commons · Mwchalmers (CC BY-SA 4.0)',
      creditUrl: 'https://commons.wikimedia.org/wiki/File:BalosLagoonCreta.jpg',
    },
    'Hydra (Saronic Islands)': {
      src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/bd/Hydra_Port_-_Saronic_Islands_of_Greece_-_Aug._2006.jpg/1920px-Hydra_Port_-_Saronic_Islands_of_Greece_-_Aug._2006.jpg',
      credit: 'Wikimedia Commons · Bob Steiner (CC BY-SA 2.0)',
      creditUrl: 'https://commons.wikimedia.org/wiki/File:Hydra_Port_-_Saronic_Islands_of_Greece_-_Aug._2006.jpg',
    },
    'Paros (Cyclades)': {
      src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/90/Venetian_Castle_Naoussa%2C_Paros%2C_Greece.jpg/1920px-Venetian_Castle_Naoussa%2C_Paros%2C_Greece.jpg',
      credit: 'Wikimedia Commons · Tommybee89 (CC BY-SA 4.0)',
      creditUrl: 'https://commons.wikimedia.org/wiki/File:Venetian_Castle_Naoussa,_Paros,_Greece.jpg',
    },
  },
};
