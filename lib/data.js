...
const LISTS = [
...

  {
    ...
    tags: ['bars', 'nightlife', 'food-drink', 'stores'],
    linkType: 'mapsCity',
    blurb: 'The cue is chalked, the table is free, and the beer is cold. Boston\'s best pool table bars run from South Boston neighborhood gems to Allston dives and the Cambridge institution that started it all.',
    defaultSource: 'ai',
    links: {
      'Croke Park (South Boston)': 'https://www.google.com/maps/search/?api=1&query=Croke%20Park%20South%20Boston',
      ...
      'J.J. Foley\'s Cafe (South End)': 'https://www.google.com/maps/search/?api=1&query=J.J.%20Foley%27s%20Cafe%20South%20End%20Boston',
      ...
      'Jacques Cabaret (Bay Village)': 'https://www.google.com/maps/search/?api=1&query=Jacques%20Cabaret%20Bay%20Village%20Boston',
