...
const LISTS = [
  ...
  },
  {
    ...
    publishedAt: '2026-06-01T03:41:13Z',
    title: 'Best Resorts in the Caribbean',
    category: 'Travel',
    type: 'travel',
    tags: ['travel', 'luxury'],
    linkType: 'mapsCity',
    blurb: 'Forbes five-star properties, Aman escapes, and island originals that have earned every accolade on the list. The Caribbean’s most acclaimed luxury resorts, by consensus.',
    defaultSource: 'ai',
    links: {
    ...
    sources: {
      ...
      travelleisure: {
        label: "Travel + Leisure · World’s Best, Caribbean 2024",
      ...
      cntraveler: {
        label: "Condé Nast Traveler · Readers’ Choice Caribbean 2024 (unordered)",
        url: 'https://www.cntraveler.com/galleries/best-hotels-in-the-caribbean',
        unordered: true,
        items: [
          'Eden Roc Cap Cana (Cap Cana, Dominican Republic)',
          'Kimpton Seafire Resort & Spa (Seven Mile Beach, Grand Cayman)',
      ...
      usnews: {
        label: 'U.S. News · Best Hotels in the Caribbean 2025',
