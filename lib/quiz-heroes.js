...
export const QUIZ_HEROES = {
  'name-the-continent-part-1': { src: 'https://upload.wikimedia.org/wikipedia/commons/8/83/Equirectangular_projection_SW.jpg', pos: 'center 45%' },
  'name-the-continent-part-2': { src: 'https://upload.wikimedia.org/wikipedia/commons/c/cb/The_Blue_Marble_%28remastered%29.jpg', pos: 'center 40%' },
  'name-the-continent-part-3': { src: 'https://upload.wikimedia.org/wikipedia/commons/0/0d/Africa_and_Europe_from_a_Million_Miles_Away.png', pos: 'center 40%' },
  'name-the-continent-part-4': { src: 'https://upload.wikimedia.org/wikipedia/commons/6/61/Blue_Marble_Western_Hemisphere.jpg', pos: 'center 40%' },
  'name-the-continent-part-5': { src: 'https://upload.wikimedia.org/wikipedia/commons/9/97/The_Earth_seen_from_Apollo_17.jpg', pos: 'center 40%' },
