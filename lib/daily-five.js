...
//
// RUNWAY: banked through 2026-10-04. Extend it before it runs out.
//
...
// 5k those days CANNOT be banked, whatever is written here. Extending this bank
// past 2026-10-04 was attempted on 2026-08-21 and is arithmetically impossible:
// most of the roster stops publishing on 2026-09-29, and the six days
// 09-30..10-05 then need 30 slots against a supply of 28 (Arcade and Cards are
// down to two games each, End Game to three, Trivia to four). The fix is always
// to extend the underlying puzzle banks, never to loosen a rule here, and
// scripts/gen-daily-five.mjs reports the exact blocking window when it hits one.
//
