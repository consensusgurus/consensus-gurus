...
export const CIRCUITS = [
  ...
  },
  {
    ...
    // Arcade was grouping. Deep, Atlas, Blitz and Streak are all multiple
    // choice, all one life, and all end on the first miss; what they are NOT is
    // arcade games, which is why they read wrong under that name and read right
    // under this one. Atlas joined at its launch on 2026-08-25, and it is a
    // Geography game in the registry, which is the other true thing about it,
    // exactly as Blitz is also Mental Math. Nothing here was taken from another
    // circuit.
