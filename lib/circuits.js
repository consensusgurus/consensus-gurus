...
export const CIRCUITS = [
  ...
  },
  {
    id: 'gauntlet',
    name: 'Gauntlet',
    blurb: 'Question after question until you miss. One wrong answer ends the run.',
    share: {
      invite: "Three games that end the moment you are wrong: one topic in depth, one clock, and forty questions of anything at all.",
      result: "Three games, one wrong answer each.",
    },
    // NEW on 2026-08-24, and it is the honest half of what the old five-game
    // Arcade was grouping. Deep, Blitz and Streak are all multiple choice, all
    // one life, and all end on the first miss; what they are NOT is arcade
    // games, which is why they read wrong under that name and read right under
    // this one. Blitz is in Mental Math as well, which is the other true thing
    // about it. Nothing here was taken from another circuit.
