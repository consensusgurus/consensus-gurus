...
// The ten daily game keys, in the display order used on the /daily hub and the
...
export const DAILY_KEYS = ['crux', 'garble', 'links', 'span', 'dating', 'tally', 'suds', 'circa', 'extra', 'carve'];
