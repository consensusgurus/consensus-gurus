...
// The daily game keys, in the display order used on the /daily hub and the
// end-screen cross-promo. Keep in sync with the daily registries (see the
// daily-game-registries note): crux, emcee, garble, links, span, dating, tally,
// suds, circa, extra, carve. `closer` is NOT a daily and is intentionally absent.
