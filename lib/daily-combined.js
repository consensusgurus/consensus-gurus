...
// tally, suds, circa, extra, carve, stet, outwit, tuck, alibi, cipher, ping. `closer` is NOT a daily and
// is intentionally absent.
export const DAILY_KEYS = ['crux', 'emcee', 'garble', 'links', 'span', 'dating', 'tally', 'suds', 'circa', 'extra', 'carve', 'stet', 'outwit', 'tuck', 'alibi', 'cipher', 'ping', 'warmer'];
